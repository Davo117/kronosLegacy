...
<p>Cantidad:<input type="text" name="cantidad" value="<?php if(isset($_GET['edit'])) echo $getROW['cantidadConfi'];  ?>"	size="20" placeholder="Cantidad" required>    
&nbsp &nbsp 
...
<br>
<p>Fecha Embarque:<input type="date" name="dateEmbar" value="<?php if(isset($_GET['edit'])) echo $getROW['embarqueConfi'];  ?>" size="20" required>
&nbsp  &nbsp 
	Fecha Entrega:<input type="date" name="dateEntre" value="<?php if(isset($_GET['edit'])) echo $getROW['entregaConfi'];  ?>"size="20" required>
	</p>   
