...
<?php 
	...
	Orden Compra:<input type="text" name="ordenC" value="<?php if(isset($_GET['edit'])) echo $getROW['orden'];  ?>"	size="20" placeholder="Número Orden" required>
	</p> <br>
	<p>Fecha Documento:<input type="date" name="dateDoc" value="<?php if(isset($_GET['edit'])) echo $getROW['documento'];  ?>" size="20" required>

	Fecha Recepción:<input type="date" name="dateRec" value="<?php if(isset($_GET['edit'])) echo $getROW['recepcion'];  ?>"size="20" required>
	</p>   
