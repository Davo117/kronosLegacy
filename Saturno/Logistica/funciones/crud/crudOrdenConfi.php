...
{	//Lanzamos la consulta actualizando la baja a 0
	...
	if(!$SQL)
	 ...
	 //Mandamos un mensaje de exito:
	echo"<script>alert('Se ha Reactivado una Confirmación.')</script>";
	echo "<META HTTP-EQUIV='REFRESH' CONTENT='1; URL=Logistica_ConfirmacionesOrden.php?mostrar'>";
	 }
}
/* Fin Código Activar */
//////////////////////////////////////////////////////////////////////////////////////////////
...
{ //Cambiar el parametro "del" para que no haya conflictos:
	...
	//En caso de ser diferente la consulta:
	 ...
	 //Mandamos un mensaje de exito:
	 echo"<script>alert('Se ha Eliminado una Confirmación Desactivada')</script>";
	 echo "<META HTTP-EQUIV='REFRESH' CONTENT='1; URL=Logistica_ConfirmacionesOrden.php?mostrar'>";
	 }
}
...
if(isset($_GET['comboconfir']))
{
	...
	header("Location: Logistica_SurtidoOrden.php");	
}
