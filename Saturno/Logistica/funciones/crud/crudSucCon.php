...
{	//Lanzamos la consulta actualizando la baja a 0
	...
	if(!$SQL)
	 ...
	 //Mandamos un mensaje de exito:
	echo"<script>alert('Se ha Reactivado Un Contacto de la Sucursal')</script>"; 
	 echo "<META HTTP-EQUIV='REFRESH' CONTENT='1; URL=Logistica_ContactoSucursales.php?mostrar'>";
	 }
}
/* Fin Código Activar */
//////////////////////////////////////////////////////////////////////////////////////////////
