...
$resultado = $MySQLiconn->query("SELECT * FROM $embarq, $tablaOrden where bajaEmb=0  and sucEmbFK=sucFK  ORDER BY idEmbarque DESC;");
...
?>
<td><a href="?activar=<?php echo $rows["idEmbarque"]; ?>" onclick="return confirm('<?php print("Deseas ACTIVAR el Embarque: ".$rows["numEmbarque"]." ?"); ?>'); " ><IMG src="funciones/img/activo.png" title='Activar'></a> 
&nbsp
<a href="?eli=<?php echo $rows["idEmbarque"]; ?>" onclick="return confirm('<?php print("Deseas ELIMINAR el Embarque: ".$rows["numEmbarque"]." ?"); ?>');" ><IMG src="funciones/img/deleteDef.png" title='Eliminar'></a></td>
<?php
