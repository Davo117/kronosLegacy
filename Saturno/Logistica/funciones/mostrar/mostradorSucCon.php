...
$resultado = $MySQLiconn->query("SELECT * FROM $tablaconsuc where bajaconsuc=1  ORDER BY idconsuc DESC;");
...
?>
<td><a href="?edit=<?php echo $rows["idconsuc"]; ?>" onclick="return confirm('<?php print("Deseas EDITAR al Contacto: ".$rows["nombreconsuc"]." ?"); ?>'); " ><IMG src="funciones/img/modify.png" title='Modificar'></a>
&nbsp 
    <a href="?del=<?php echo $rows["idconsuc"]; ?>" onclick="return confirm('<?php print("Deseas ELIMINAR al Contacto: ".$rows["nombreconsuc"]." ?"); ?>');" ><IMG src="funciones/img/delete.png" title='Desactivar'></a></td>
<?php
