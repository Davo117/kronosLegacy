...
<?php 
    ...
    * Nombre:<input type="text" name="Nombre" value="<?php if(isset($_GET['edit'])) echo $getROW['nombreconcli'];  ?>"  size="20" placeholder="Nombre Completo" required>
  
	* Puesto:<input type="text" name="Puesto" value="<?php if(isset($_GET['edit'])) echo $getROW['puestoconcli'];  ?>" size="20" placeholder="Puesto" required>
	</p>   <br>

	<p>* Teléfono:<input type="text" name="Telefono" value="<?php if(isset($_GET['edit'])) echo $getROW['telefonoconcli'];  ?>"size="20" placeholder="Número Telefónico" required>
	
	Celular:<input type="text" name="Celular" value="<?php if(isset($_GET['edit'])) echo $getROW['movilcl'];  ?>" 	size="20" placeholder="Celular" >
	
    * Correo:<input type="text" name="Correo" value="<?php if(isset($_GET['edit'])) echo $getROW['emailconcli'];  ?>" size="20" placeholder="Correo Electrónico" required>
    </p> 
