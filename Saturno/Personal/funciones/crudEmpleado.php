...
if(isset($_POST['save']))
{
	...
	//Realizamos la consulta
	 $SQL =$MySQLiconn->query("INSERT INTO empleado(numemple,Nombre,apellido,Telefono,departamento) VALUES('$numemp','$nombre','$ape','$telefono','$dep')");
...
if ($_POST['NumEmp']=="" or $_POST['Nombre']=="" or $_POST['Apellido']=="" or $_POST['Telefono']=="" ){
	...
	$SQL = $MySQLiconn->query("UPDATE empleado SET numemple='".$_POST['NumEmp']."', Nombre='".$_POST['Nombre']."', apellido='".$_POST['Apellido']."', Telefono='".$_POST['Telefono']."', departamento='".$_POST['Depa']."' WHERE id=".$_GET['edit']);
if(!$SQL)
	 {
	 	//Mandar el mensaje de error
		 echo $MySQLiconn->error;
