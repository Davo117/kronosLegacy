...
if(isset($_POST['save']))
{
	...
	ON  s.descripcionSustrato=i.sustrato WHERE i.descripcionImpresion='".$descripcionImpresion."'");
	$dim=$cat->fetch_array();
	...
	if(($dim['anchoPelicula']*$repAlPaso)==$dim['anchura'])
	{
