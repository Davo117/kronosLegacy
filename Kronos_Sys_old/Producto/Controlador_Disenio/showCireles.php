...
$q=$_GET['q'];
$resultado = $MySQLiconn->query("SELECT  DISTINCT j.id, j.num_dientes, j.producto, j.identificadorJuego, j.ancho_plano, i.alturaEtiqueta, i.anchoPelicula, i.descripcionImpresion,l.estado as prod from juegoscireles  j inner join impresiones  i on j.producto=i.codigoImpresion
