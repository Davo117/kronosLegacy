...
$q=$_GET['q'];
$resultado = $MySQLiconn->query("SELECT j.id, j.num_dientes, j.producto, j.identificadorJuego, j.ancho_plano, i.alturaEtiqueta, i.anchoPelicula, i.descripcionImpresion from juegoscireles as j inner join impresiones as i on j.producto=i.codigoImpresion where j.baja=0 and i.baja=1 and j.producto='$q'");
