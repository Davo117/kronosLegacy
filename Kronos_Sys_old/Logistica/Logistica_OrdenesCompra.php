...
<div class="panel panel-default">
                ...
                <div class="panel-heading"><b class="titulo">Ordenes de compra</b>
                    <?php 
...
<input type="text" id="ordenC" class="form-control" name="ordenC" value="<?php if(isset($_GET['edit'])) echo $getROW['orden'].'" readonly="true';  ?>"	size="20" placeholder="Número Orden" required>
</div>
...
<?php include ("funciones/mostrar/mostradorOC.php"); 
echo'</table>';
