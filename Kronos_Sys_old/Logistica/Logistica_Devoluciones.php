...
if ($_GET==false) {   ?>
  ...
  <div class="panel panel-default">
                ...
                <div class="panel-heading"><b class="titulo">Devoluciones</b>
                </div>
 <div class="panel-body">
   ...
   <div class="btn-group btn-group-toggle" data-toggle="buttons" id="radios">
      <label class="btn btn-secondary"><input  type="radio" name="radio1" value="0">Embarque</label>
      <label class="btn btn-secondary"> <input type="radio" name="radio1" value="1">Empaque</label>
      <label class="btn btn-secondary"><input  type="radio" name="radio1" value="2">Paquete</label>
      <label class="btn btn-secondary"> <input  type="radio" name="radio1" value="3">Rollo</label>
...
elseif($_GET==true ){
   ...
   if($_GET['r']!='--') {
      ...
      <select name="example" class="form-control" id="example">
