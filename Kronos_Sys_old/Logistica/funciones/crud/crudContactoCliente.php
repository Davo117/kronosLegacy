...
{	//Lanzamos la consulta actualizando la baja a 0
	...
	if(!$SQL)
	 ...
	 //Mandamos un mensaje de exito:
	echo"<script>alert('Se ha Activado Un Contacto del Cliente')</script>"; 
...
{	//Lanzamos la consulta actualizando la baja a 0
	...
	else header("Location: Logistica_ContactoClientes.php");
	/*echo"<script>alert('Se ha Desactivado Un Contacto Cliente')</script>"; 
	 echo "<META HTTP-EQUIV='REFRESH' CONTENT='1; URL=Logistica_ContactoClientes_bajas.php'>";
	 }*/
}
...
if(isset($_GET['edit']))
{
	...
	$_SESSION['cliente']=$getROW['idcliFK'];
}
