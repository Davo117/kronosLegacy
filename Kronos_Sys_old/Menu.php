...
<div class="container" >
	<div class="col-xs-6"><a href="../Inventario/"><img style="" src="pictures/logo-labro.png" class="img-responsive"></a><h3 class="display-4">Sistema de control de producción</h3>
				</div>
	<div class="col-xs-6" >
...
<hr style="color:black;background-color:black;border-color:#797979;width:80%">
