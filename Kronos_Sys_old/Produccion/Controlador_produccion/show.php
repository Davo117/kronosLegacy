...
$comparador=0;
?>
<p style="font:bold 15px Sansation Light;padding-top:10px;"><?php echo "codigos agregados:  ";?><b style="font:bold 20px Sansation;"><?php echo count($_SESSION['arrayBS']);?></b><?php
...
for($i=0;$i<count($_SESSION['arrayBS']);$i++)
  {
    ?>
      <p class='paquetes'><?php echo $_SESSION['arrayBS'][$i];?></p>
      <?php
      $comparador=$i;
  }
