...
if (file_exists($name_document)) {
    echo "<script>window.location='$name_document?etiquetas=".$_GET['generarAll']."';</script>";
} else {
    echo "<script>window.location='etiquetas/generarEtiquetasAll.php?etiquetas=".$_GET['generarAll']."';</script>";
}
