...
<input type="text" id="codigo" class="form-control" name="codigo" value="" size="20" placeholder="Código/NoOp" required>
</div>
<?php
	}
	else
...
<input type="text" class="form-control" name="codigo" value="" id="codigo" size="20" placeholder="Código/NoOp" required>
</div>
<?php
	}
}
...
{?>
<div class="col-xs-3"><label for="codigo">Código</label>
<input type="text" name="codigo" value="" class="form-control" id="codigo" size="20" placeholder="Código/NoOp" required>
</div>
<?php
}
