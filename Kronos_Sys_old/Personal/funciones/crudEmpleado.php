...
if(isset($_POST['update'])){
	if ($_POST['NumEmp']=="" or $_POST['Nombre']=="" or $_POST['Apellido']=="" ){
		...
		$SQL = $MySQLiconn->query("UPDATE $tablaem SET numemple='".$_POST['NumEmp']."', Nombre='".$_POST['Nombre']."', apellido='".$_POST['Apellido']."', Telefono='".$_POST['Telefono']."', departamento='".$_POST['Depa']."' WHERE id=".$_GET['edit']);
		if(!$SQL){
		 	//Mandar el mensaje de error
			echo $MySQLiconn->error;
		}
