...
$mostrar=$MySQLiconn->query("select packparametros from procesos where descripcionProceso='$q'
");
$row1 = $mostrar->fetch_array();


$resultado = $MySQLiconn->query("select * from juegoparametros where identificadorJuego='".$row1['packparametros']."'");
...
<td>
    ...
    <a href="?del=<?php echo $rows["id"]; ?>" ><IMG src="../pictures/deletProducto.png" title='eliminar'></a> &nbsp &nbsp  <?php echo '['.$rows['numParametro'].']'; ?></td>
...
select packparametros from procesos where descripcionProceso='Impresion'
