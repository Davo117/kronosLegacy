...
<?php
	...
	if(isset($_GET['Buscar']) && !empty($getRow) && empty($getRow['peso']))
	{
		?>
<form role="form">
...
<input id="peso" class="form-control" onkeypress="return numeros(event)" style="margin-bottom:15px;margin-top:10px;color:black;" autofocus required type="text" name="peso" placeholder="kilos">
</div>
</div>
...
<div class="panel-body">
		<?php $_SESSION['empaqueActual']=$_SESSION['empaqueActual'];?>
			...
			<h4>Producto:<b class="bes3"><?php echo $getRow['producto'];?></b></h4>
