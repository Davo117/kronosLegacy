...
<div id="barra-lateral">
			...
			<div id="totales"  class="contenedor-logos"><a href='../Personal/index.php'>
			...
			<div onclick="document.location.href='../Logistica/Logistica_Clientes.php'" id="totales" id="totales" class="contenedor-logos">
			...
			<div id="totales" class="contenedor-logos">
				...
				<pre class="title-menu">Calidad</pre>
			</div>
