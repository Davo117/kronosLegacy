...
<p>Transporte:<input type="text" name="transporte" value="<?php if(isset($_GET['edit'])) echo $getROW['transpEmb'];  ?>"  size="20" placeholder="Transporte" >    
&nbsp &nbsp &nbsp 
...
<br>
<p>Fecha Embarque:<input type="date" name="dateEmbar" value="<?php if(isset($_GET['edit'])) echo $getROW['diaEmb'];  ?>" size="20">
&nbsp  &nbsp &nbsp 
