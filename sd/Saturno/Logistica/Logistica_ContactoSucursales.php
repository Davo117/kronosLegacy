...
<?php 
    ...
    >Nombre:<input type="text" name="Nombre" value="<?php if(isset($_GET['edit'])) echo $getROW['nombreconsuc'];  ?>" size="20" placeholder="Nombre Completo">    

	Puesto:<input type="text" name="Puesto" value="<?php if(isset($_GET['edit'])) echo $getROW['puestoconsuc'];  ?>" size="20" placeholder="Puesto" >
	</p>   <br>

	<p>Teléfono:<input type="text" name="Telefono" value="<?php if(isset($_GET['edit'])) echo $getROW['telconsuc'];  ?>"size="20" placeholder="Número Telefónico">   

	Celular:<input type="text" name="Celular" value="<?php if(isset($_GET['edit'])) echo $getROW['movilconsuc'];  ?>" size="20" placeholder="Celular" >

	Correo:<input type="text" name="Correo" value="<?php if(isset($_GET['edit'])) echo $getROW['emailconsuc'];  ?>" size="20" placeholder="Correo Electrónico" >
	</p> 
