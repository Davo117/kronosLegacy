...
/*
            ...
            { $fchoperacion = date('Y-m-d');  
              ...
              { if ($alptEmpaque_pesobruto <= $alptEmpaque_pesos)
                { $msg_info = "El peso bruto del empaque es menor o igual al peso interno. <br/>
    ...
    echo '
    <form id="form_empaque" name="form_empaque" method="POST" action="alptEmpaque.php"/>
      <table align="center">
        <thead>
