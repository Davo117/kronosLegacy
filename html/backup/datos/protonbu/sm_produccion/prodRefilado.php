    ...
    { $regRechEmpleado = $rechEmpleadoSelect->fetch_object();
      ...
      { $regProdMaquina = $prodMaquinaSelect->fetch_object();
        ...
        $link_mysql = conectar();
          ...
          AND (prodlote.noop = '".$prodRefilado_cdglote."'
  	  		OR prodlote.cdglote = '".$prodRefilado_cdglote."')
          ...
          $prodRefilado_proyecto = $regProdLote->proyecto;
          $prodRefilado_impresion = $regProdLote->impresion;
          $prodRefilado_cdgimpresion = $regProdLote->cdgimpresion;
          $prodRefilado_numbobinas = 9; //$regProdLote->alpaso;
          $prodRefilado_idmezcla = $regProdLote->idmezcla;
          $prodRefilado_mezcla = $regProdLote->mezcla;
          $prodRefilado_cdgmezcla = $regProdLote->cdgmezcla;
              ...
              { if ($error_peso == false)
                { $link_mysqli = conectar();
                  ...
                  $link_mysqli->query("
                    ...
                    VALUES
                      ('".$prodRefilado_cdglote."', '30001', '".$prodRefilado_cdgempleado."', '".$prodRefilado_cdgmaquina."', '".$fchoperacion."', NOW())");                
                  ...
                  $msg_modulo = '<a href="pdf/prodBobinaBC.php?cdglote='.$prodRefilado_cdglote.'" target="_blank">Generar etiquetas</a>';
