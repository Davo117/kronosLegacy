<?php
  ...
  { $regPdtoImpresion = $pdtoImpresionSelect->fetch_object();
    ...
    $_SESSION['prodlote_producto'] = $regPdtoImpresion->impresion;    
  ...
  if ($_GET['cdgproceso'] == 10) { $_SESSION['status_lote'] = 'Programado'; }  
  if ($_GET['cdgproceso'] == 30) { $_SESSION['status_lote'] = 'Impreso'; }
  ...
  { class PDF extends FPDF
    { function Header()
      { if ($_SESSION['usuario'] == '')
        ...
        $this->Cell(0,4,'Inventario de lotes por producto '.$_SESSION['prodlote_producto'],0,1,'R');
