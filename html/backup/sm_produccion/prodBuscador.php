      ...
      <section>
        <article>
          <dl>
            ...
            <dd>
              <dl>
                <dt><input type="radio" name="radioCode" id="radioCode" value="0" disabled/> '.utf8_decode('Producto en proceso').'</dt>
      ...
      case 0: 
        ...
        { while ($regQueryRolloOpe = $querySelectRolloOpe->fetch_object())
          { $idRolloOpe++;
            ...
            $prodBuscador_longitudrollo[$idRolloOpe] = $regQueryRolloOpe->longitud;
        ...
        { while ($regQueryLoteOpe = $querySelectLoteOpe->fetch_object())
          { $idLoteOpe++;
            ...
            $prodBuscador_longitudlote[$idLoteOpe] = $regQueryLoteOpe->longitud;
