...
<html>
  ...
  { //Buscame los datos ingresados  
    ...
    $prodImpresion_cdgjuego = trim($_POST['text_juego']);
    ...
    { $regRechEmpleado = $rechEmpleadoSelect->fetch_object();
      ...
      { $regProdMaquina = $prodMaquinaSelect->fetch_object();
        ...
        //Buscar juego de rodillos
        $link_mysql = conectar();
        $pdtoJuegoSelect = $link_mysql->query("
          SELECT * FROM pdtojuego
          WHERE cdgjuego = '".$prodImpresion_cdgjuego."' AND
            sttjuego = '1'");
        ...
        { $regPdtoJuego = $pdtoJuegoSelect->fetch_object();
    	  ...
    	  WHERE proglote.cdglote = prodlote.cdglote AND 
             ...
             (pdtodiseno.cdgdiseno = pdtojuego.cdgdiseno AND
              pdtojuego.cdgjuego = '".$prodImpresion_cdgjuego."') AND              
              prodlote.sttlote = 'A'");
            ...
            $prodImpresion_longin = $regProdLote->longin;
            ...
            $prodImpresion_diseno = $regProdLote->diseno;
            $prodImpresion_idjuego = $regProdLote->idjuego;
            $prodImpresion_cdgjuego = $regProdLote->cdgjuego;
            $prodImpresion_proveedor = $regProdLote->proveedor;
            $prodImpresion_impresion = $regProdLote->impresion;
            $prodImpresion_cdgimpresion = $regProdLote->cdgimpresion;
                ...
                { $link_mysqli = conectar();
                  ...
                  { $msg_alert .= 'Proceso registrado. \n'; 
                    ...
                    $link_mysqli->query("
                      ...
                      VALUES
                        ('".$prodImpresion_cdglote."', '20001', '".$prodImpresion_cdgempleado."', '".$prodImpresion_cdgmaquina."', '".$prodImpresion_cdgjuego."', '".$prodImpresion_longin."', '".$prodImpresion_longitud."', '".$fchoperacion."', NOW())");                       
        ...
        { $prodImpresion_cdgjuego = '';
          $msg_alert = 'Referencia de Juego de rodillos, incorrecta.';
          $text_juego = 'autofocus'; }
      } else
    ...
    <form id="form_prodimpresion" name="form_pdtoimpresion" method="post" action="prodImpresion.php"/>
      <table align="center">
        ...
        <tbody>
          ...
          <tr><td><label for="label_ttljuego">Juego de rodillos</label><br/>
              <input type="text" style="width:120px" id="text_juego" name="text_juego" value="'.$prodImpresion_cdgjuego.'" '.$text_juego.' required/></td></tr>
        ...
        <tbody>
          ...
          <tr><td>
              <table>
                ...
                <tfoot align="left">
                  <tr><th>Diseno</th>
                    <th colspan="2">'.$prodImpresion_diseno.'</th></tr>
              ...
              <input type="hidden" id="text_juego" name="text_juego" value="'.$prodImpresion_cdgjuego.'" '.$text_juego.' required/>
            </td>
            <td>
              <table align="center">
                <thead>
              ...
              <table>
                <thead>
                  <th colspan="2">Informaci&oacute;n del juego de rodillos</th></tr>
                </thead>
                <tbody>
                  <tr><td>idJuego</td><td>'.$prodImpresion_idjuego.'</td></tr>
                  <tr><td>Proveedor</td><td>'.$prodImpresion_proveedor.'</td></tr>
                </tbody>
                <tfoot>
                  <tr><th colspan="2"></th></tr>
              </table>
