            ...
            { echo '
                <tr align="center">
                  ...
                  <td><a href="pdf/prodCalendarioPdf.php?dsdfecha='.$prodCalendario_iddiames.'&hstfecha='.$prodCalendario_iddiames.'&cdgproceso='.$prodCalendario_cdgproceso.'&cdgempleado='.$prodCalendario_cdgempleado.'&cdgproducto='.$prodCalendario_cdgproducto.'" target="_blank">'.$png_acrobat.'</a>
				    <a href="pdf/RC-01-POT-7.5.php?dsdfecha='.$prodCalendario_iddiames.'&hstfecha='.$prodCalendario_iddiames.'&cdgproceso='.$prodCalendario_cdgproceso.'&cdgempleado='.$prodCalendario_cdgempleado.'&cdgproducto='.$prodCalendario_cdgproducto.'" target="_blank">'.$png_pnc.'</a></td>
                </tr>'; }
