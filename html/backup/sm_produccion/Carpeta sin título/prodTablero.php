  ...
  { echo '
    ...
    { $prodTablero_total = ($prodTablero_impreso[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_refilado[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_liberado1[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_transferido[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_enbobina[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_fusionado[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_revisado[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_liberado2[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_pesado[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_queso[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_paquete[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]+$prodTablero_caja[$prodTablero_cdgimpresion[$idProyecto][$idProducto]]);
      ...
      { $prodTablero_sumexistencia[0] += $prodTablero_total;
        ...
        echo '
        <tr>
          <td><strong>'.$prodTablero_impresion[$idProyecto][$idProducto].'</strong><br/><br/>
            <table align="right">              
              <tr><td>Inventario</td>
                ...
                <td></td></tr>
              <tr><td>Requerido</td>
                <td align="right"><label title="'.$prodTablero_impresion[$idProyecto][$idProducto].' '.$numTintas.' tintas"><strong><font color="'.$colortexto.'">'.number_format(($sinprogramar),3,'.',',').'</font></strong></label></td>
                <td></td>
                <td></td></tr>  
              <tr><td>Programado</td>
                ...
                <td><a href="pdf/prodLotesPdf.php?cdgproceso=10&cdgproducto='.$prodTablero_cdgimpresion[$idProyecto][$idProducto].'" target="_blank">'.$png_acrobat.'</a></td>
                <td><a href="pdf/prodLotesBC.php?cdgproceso=10&cdgproducto='.$prodTablero_cdgimpresion[$idProyecto][$idProducto].'" target="_blank">'.$png_barcode.'</a></td></tr>                
            </table>
            </td>
          <td>';
        ...
        echo '
              <tr><td align="right"><label title="Suma">'.number_format($prodTablero_sumaimpresion[$idProyecto][$idProducto],3,'.',',').'</label></td>
                <td colspan="2">Mlls</td></tr>
            </table></td>
          <td>
            <table align="right">';
        ...
        echo '
              <tr><td align="right"><label title="Suma">'.number_format($prodTablero_sumafusion[$idProyecto][$idProducto],3,'.',',').'</label></td>
                <td colspan="2">Mlls</td></tr>
            </table>
          </td>
        ...
        echo '
              <tr><td>Cortado</td>
                <td align="right"><label title="'.$prodTablero_impresion[$idProyecto][$idProducto].'">'.number_format($prodTablero_paquete[$prodTablero_cdgimpresion[$idProyecto][$idProducto]],3,'.',',').'</label></td>
        ...
        { $prodTablero_sumenviado[0] += $prodTablero_productoenv[$prodTablero_cdgimpresion[$idProyecto][$idProducto]];
          ...
          echo '
            <label title="'.$prodTablero_impresion[$idProyecto][$idProducto].'"><strong>'.number_format($prodTablero_productoenv[$prodTablero_cdgimpresion[$idProyecto][$idProducto]],3,'.',',').'</strong></label><br/>
            <label title="Pieza cortada">'.number_format($prodTablero_cajaenv[$prodTablero_cdgimpresion[$idProyecto][$idProducto]],3,'.',',').' <strong>C</strong></label><br/>
            <label title="Banda">'.number_format($prodTablero_rolloenv[$prodTablero_cdgimpresion[$idProyecto][$idProducto]],3,'.',',').' <strong>Q</strong></label>'; }
