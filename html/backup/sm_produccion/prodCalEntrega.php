...
<html>
  ...
  if ($prodCalendario_dia1mes == 7)
  { $prodCalendario_dia1mes = 0; }
  ...
  { // Busqueda de compromisos por fecha embarque 
    ...
    SUM(vntsoclote.cantidad-vntsoclote.surtido) AS cantidad
      ...
      WHERE vntsoc.cdgoc = vntsoclote.cdgoc AND
        ...
        vntsoclote.fchembarque BETWEEN '".$prodCalEntrega_idanoprevio."-".str_pad($prodCalEntrega_idmesprevio, 2, '0', STR_PAD_LEFT)."-01' AND '".$prodCalEntrega_idanosiguiente."-".str_pad($prodCalEntrega_idmessiguiente, 2, '0', STR_PAD_LEFT)."-31'
      ...
      { while($regProdCalEntrega = $prodCalEntregaSelectLote->fetch_object())
        { $prodFchCalEntrega[$regProdCalEntrega->fchembarque] = $regProdCalEntrega->cantidad; }
      } 
  } else
  { if ($prodCalEntrega_cdgsucursal == '' AND $prodCalEntrega_cdgproducto == '')
    { // Busqueda de compromisos por fecha embarque 
    ...
    { $id_proyecto = 1;
      ...
      { $pdtoProyecto_idproyecto[$id_proyecto] = $regPdtoProyecto->iddiseno;
        ...
        $pdtoImpresionSelect = $link_mysqli->query("
          ...
          WHERE cdgproyecto = '".$regPdtoProyecto->cdgdiseno."' AND 
            sttimpresion = '1'
          ORDER BY impresion,
            idimpresion");
  ...
  echo '
    ...
    <table align="center">
      <thead>
        <tr align="center"><td colspan="8">Calendario de entregas para producci&oacute;n</td></tr>
        <tr align="center">
          <th><a href="prodCalEntrega.php?idano='.$prodCalEntrega_idanoprevio.'&idmes='.$prodCalEntrega_idmesprevio.'&cdgsucursal='.$prodCalEntrega_cdgsucursal.'&cdgproducto='.$prodCalEntrega_cdgproducto.'&cdgproducto='.$prodCalEntrega_cdgproducto.'">'.$png_button_blue_rew.'</a></th>
          ...
          <th><a href="prodCalEntrega.php?idano='.$prodCalEntrega_idanosiguiente.'&idmes='.$prodCalEntrega_idmessiguiente.'&cdgsucursal='.$prodCalEntrega_cdgsucursal.'&cdgproducto='.$prodCalEntrega_cdgproducto.'">'.$png_button_blue_ffw.'</a></th>
        </tr>
        <tr>';
	...
	$prodCalEntrega_iddiamp = (($prodCalEntrega_diasmesprevio+1)-($prodCalEntrega_dia1mes));
          ...
          <td style="background:orange;"> 
            ...
            { echo '
                <tr align="center">
                  ...
                  <td></td>
                  <td><a href="pdf/prodCalEntregaPdf.php?dsdfecha='.$prodCalEntrega_iddiames.'&hstfecha='.$prodCalEntrega_iddiames.'&cdgsucursal='.$prodCalEntrega_cdgsucursal.'&cdgproducto='.$prodCalEntrega_cdgproducto.'" target="_blank">'.$png_acrobat.'</a></td>                     
                </tr>'; }              
    ...
    { echo '
                <tr align="center">
                  <td align="right"><b></b></td>
                  <td></td>
                  <td><a href="pdf/prodCalEntregaPdf.php?dsdfecha='.$prodCalEntrega_inisemana.'&hstfecha='.$prodCalEntrega_finsemana.'&cdgsucursal='.$prodCalEntrega_cdgsucursal.'&cdgproducto='.$prodCalEntrega_cdgproducto.'" target="_blank">'.$png_acrobat.'</a></td>
                </tr>'; }              
  ...
  echo '
      <tfoot>
        <form id="form_ventas" name="form_ventas" method="POST" action="prodCalEntrega.php" onSubmit="return validarNewItem()">
    ...
    echo '
          ...
          <td align="center" colspan="4"><strong>Rango de fechas</strong> <a href="pdf/prodCalEntregaPdf.php?dsdfecha='.$prodCalEntrega_dsdrngfecha.'&hstfecha='.$prodCalEntrega_hstrngfecha.'&cdgsucursal='.$prodCalEntrega_cdgsucursal.'&cdgproducto='.$prodCalEntrega_cdgproducto.'" target="_blank">'.$png_acrobat.'</a><br/>
