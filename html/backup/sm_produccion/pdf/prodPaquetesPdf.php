  ...
  { class PDF extends FPDF
    { function Header()
      { if ($_SESSION['usuario'] == '')
        ...
        $this->Cell(0,4,utf8_decode('Inventario en paquetes: '.$_SESSION['prodpaquete_impresion'].' ('.$_SESSION['prodpaquete_diseno'].')'),0,1,'R');
        ...
        $this->Cell(35,4,utf8_decode('Código paquete'),0,0,'L',true);
    ...
    { if ($prodDocumento_impresion == '')
      ...
      $pdf->Cell(35,4,$regProdSubLote->cdgpaquete,1,0,'R');
