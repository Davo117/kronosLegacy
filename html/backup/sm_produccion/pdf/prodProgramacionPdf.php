<?php
  ...
  $prodLoteSelect = $link_mysqli->query("
    SELECT proglote.tarima,
		...
		WHERE proglote.cdglote = prodlote.cdglote AND
		 ...
		 (prodloteope.cdgoperacion = '01001' AND 
	...
	{ // Cabecera de página
		...
		{ $this->SetFont('Arial','B',8);
		  ...
		  $this->Cell(0.5,4,'',0,1,'R',true);
			...
			$this->Cell(75,4,utf8_decode('Orden de trabajo de Impresión en Huecograbado'),0,1,'L');
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('RC-01-POT-7.5.1-01'),0,1,'L');
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('1.0'),0,1,'L');
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('14 Febrero 2014'),0,1,'L');
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('Impresor en Huecograbado'),0,1,'L'); 
  ...
  $pdf->Cell(45,4,'Metros',1,0,'C');
  $pdf->Cell(45,4,'Kilos',1,0,'C');
  $pdf->Cell(30,8,utf8_decode('Fecha impresión'),1,1,'C');
  ...
  $pdf->Cell(25,4,'Entregados',1,0,'C');
  $pdf->Cell(20,4,'Recibidos',1,0,'C');
  $pdf->Cell(25,4,'Entregados',1,1,'C');
  ...
  $pdf->SetFont('Arial','B',10);
  $pdf->Cell(10,8,'#',0,0,'C');  
  $pdf->Cell(50,8,'Tinta',1,0,'C');
  
  $pdf->SetFont('Arial','B',8);

  $pdf->Cell(75,4,'Kilos de tinta',1,0,'C');
  $pdf->Cell(60,4,utf8_decode('Parametros de operación'),1,1,'C');

  $pdf->SetFont('Arial','',8);
  $pdf->Cell(60,4,'',0,0,'C');  
  $pdf->Cell(25,4,'Requeridos',1,0,'C');
  $pdf->Cell(25,4,'Recibidos',1,0,'C'); 
  $pdf->Cell(25,4,'Entregados',1,0,'C');
  $pdf->Cell(20,4,'Disolvente',1,0,'C');
  $pdf->Cell(20,4,'Viscosidad',1,0,'C');
  $pdf->Cell(20,4,'Temperatura',1,1,'C');
  ...
  {  $pdf->SetFont('Arial','B',12);
      ...
      $pdf->SetFont('Arial','B',10);
      $pdf->Cell(25,8,$oplist_consumo[$idTinta],1,0,'R'); 
      $pdf->Cell(25,8,'',1,0,'R');
      $pdf->Cell(25,8,'',1,0,'R');
      
      $pdf->SetFont('Arial','',10);
      $pdf->Cell(20,8,$oplist_disolvente[$idTinta],1,0,'L');
      
      $pdf->SetFont('Arial','B',10);
      $pdf->Cell(20,8,$oplist_viscosidad[$idTinta],1,0,'C');
      $pdf->Cell(20,8,$oplist_temperatura[$idTinta],1,1,'C'); }
  ...
  ////////////////////////////////////////////////
	$pdf->Output('RC-01-POT-7.5.1-01.pdf', 'D');
?>