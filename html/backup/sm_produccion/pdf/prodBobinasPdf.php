  ...
  { class PDF extends FPDF
    { function Header()
      { if ($_SESSION['usuario'] == '') { $_SESSION['usuario'] = 'Invitado'; }
        ...
        $this->Cell(0,4,utf8_decode('Inventario en bobinas: '.$_SESSION['prodbobina_impresion'].' ('.$_SESSION['prodbobina_diseno'].')'),0,1,'R');
        ...
        $this->Cell(35,4,utf8_decode('Código bobina'),0,0,'L',true);
    ...
    { if ($prodDocumento_impresion == '')
      ...
      $pdf->Cell(35,4,$regProdSubLote->cdgbobina,1,0,'R');
