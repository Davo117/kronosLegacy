<?php
  require('../../fpdf/fpdf.php');
	...
	{ // Cabecera de página
		...
		{ $this->SetFont('Arial','B',8);
			...
			$this->Cell(45,4,utf8_decode('Elaboró y revisó'),0,0,'R');
			$this->Cell(0.5,4,'',0,1,'R',true);
			$this->Cell(45,4,utf8_decode('Aprobó'),0,0,'R');
			$this->Cell(0.5,4,'',0,1,'R',true);
		  ...
		  $this->Cell(0.5,4,'',0,1,'R',true);
			...
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('RC-01-PSG-7.2'),0,1,'L');
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('1.0'),0,1,'L');
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('Abril 21, 2014'),0,1,'L');
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('Vendedor'),0,1,'L'); 
      ...
      $this->Ln(4);
	    ...
	    $this->Cell(195.9,4,utf8_decode('Nombre y firma de quien realizo el registro'),0,1,'C');
		  ...
		  $this->SetY(-7.5);
		  $this->Cell(0,6,utf8_decode('Sistema de Gestión de Calidad Grupo Labro / Página '.$this->PageNo().' de {nb}'),0,1,'R'); 	    
		}
	}
  ...
  $pdf->Cell(50,8,utf8_decode('Información para suaje o fusión'),0,1,'L');
  ...
  $pdf->Cell(40,4,utf8_decode('Ancho final'),0,0,'R');
  $pdf->Cell(0.5,4,'',0,0,'R',true);
  $pdf->Cell(50.5,4,'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _',0,1,'L');

  $pdf->Cell(40,4,utf8_decode('Alto'),0,0,'R');
  $pdf->Cell(0.5,4,'',0,0,'R',true);
  $pdf->Cell(50.5,4,'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _',0,0,'L');

  $pdf->Cell(40,4,utf8_decode('Alto final'),0,0,'R');
  $pdf->Cell(0.5,4,'',0,0,'R',true);
  $pdf->Cell(50.5,4,'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _',0,1,'L');
  ...
  $pdf->Cell(40,4,utf8_decode('Etiquetas al paso'),0,0,'R');
  $pdf->Cell(0.5,4,'',0,0,'R',true);
  $pdf->Cell(50.5,4,'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _',0,1,'L');
  ...
  $pdf->Cell(21,8,utf8_decode(''),0,0,'L');
  $pdf->Cell(50,8,utf8_decode('Presentación Rollo'),0,0,'L');

  $pdf->Cell(41,8,utf8_decode(''),0,0,'L');
  $pdf->Cell(50,8,utf8_decode('Presentación Paquete'),0,1,'L');

  $pdf->SetFont('Arial','I',8);

  $pdf->Cell(40,4,utf8_decode('Millares por rollo'),0,0,'R');
  $pdf->Cell(0.5,4,'',0,0,'R',true);
  $pdf->Cell(50.5,4,'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ ',0,0,'L');

  $pdf->Cell(40,4,utf8_decode('Millares por paquete'),0,0,'R');
  $pdf->Cell(0.5,4,'',0,0,'R',true);
  $pdf->Cell(50.5,4,'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _',0,1,'L');
  ...
  $pdf->Cell(40,4,utf8_decode('Piezas punteadas'),0,0,'R');
  $pdf->Cell(0.5,4,'',0,0,'R',true);
  ...
  $pdf->SetFont('Arial','',8);
  $pdf->MultiCell(0,5,utf8_decode('Anexo a este registro debe encontrarse una impresión del diseño donde se aprecien las medidas indicadas y el desarmado en capas del diseño con una impresión por cada capa con el orden en que debe ser impreso.'));
  
  ////////////////////////////////////////////////
	$pdf->Output('RC-01-PSG-7.2.pdf', 'D');
?>