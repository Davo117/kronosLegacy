...
QRcode::png("www.grupolabro.co", "labro.png");
...
/*
  ...
  { 
    ...
    { 
      ...
      $pdf->Cell(25,4,number_format($regPackingList_Detalle->cantidad,3),0,0,'C');
      $pdf->Cell(25,4,number_format($regPackingList_Detalle->peso,3),0,1,'C');

      $packingList_sumamillares += $regPackingList_Detalle->cantidad;
