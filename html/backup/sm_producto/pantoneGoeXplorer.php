...
<html>
  ...
  { for ($idTinta=1; $idTinta<=$numTintas; $idTinta++)
    { if ($pdtoTintas_hexadecimal[$idTinta] == strtoupper(str_pad($pdtoTintas_RH[$idTinta],2,'0',STR_PAD_LEFT).str_pad($pdtoTintas_GH[$idTinta],2,'0',STR_PAD_LEFT).str_pad($pdtoTintas_BH[$idTinta],2,'0',STR_PAD_LEFT)))
      { $alerta = 'OK'; }
      else
      { $alerta = 'XXXXXXX';
        ...
        $link_mysqli->query("
      UPDATE pantone
      SET HTML = '".strtoupper(str_pad($pdtoTintas_RH[$idTinta],2,'0',STR_PAD_LEFT).str_pad($pdtoTintas_GH[$idTinta],2,'0',STR_PAD_LEFT).str_pad($pdtoTintas_BH[$idTinta],2,'0',STR_PAD_LEFT))."',
        pantone = CONCAT(pantone,' ('".$pdtoTintas_hexadecimal[$idTinta]."')')
      WHERE idpantone = '".$pdtoTintas_idtinta[$idTinta]."'");
      ...
      echo '
          <tr align="center">
            ...
            <td align="left">'.$pdtoTintas_pagina[$idTinta].' '.$pdtoTintas_hexadecimal[$idTinta].' '.$alerta.'</td>
            ...
            <td><a href="pdtoTinta.php?cdgtinta='.$pdtoTintas_cdgtinta[$idTinta].'">'.$png_search.'</a></td></tr>';
    } 
  }
