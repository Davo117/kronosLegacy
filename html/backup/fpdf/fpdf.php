...
function FPDF($orientation='P', $unit='mm', $format='A4')
{
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008), 'lbl4x2'=>array(288,144));
	if(is_string($format))
...
{ $this->SetY(-10);
  ...
  $this->Cell(0,6,'Consultado '.date("Y-m-d").' '.date("G:i:s").'',0,1,'R'); 
  $this->SetFont('arial','',8);
  $this->SetY(-7.5);
  $this->Cell(0,6,'Proton para Grupo Labro Pagina '.$this->PageNo().'/{nb}',0,1,'R'); 
	//To be implemented in your own inherited class
}
