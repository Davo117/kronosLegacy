...
<?php
  ...
  { if ($_GET['mode']=='logout') { cl0s3(); }
    ...
    { echo '
      <div id="loginform">
        <form id="login" action="prodProgramacionBS.php" method="POST">';
    ...
    echo '
      <form id="frmProgramacion" name="frmProgramacion" method="POST" action="prodProgramacionBS.php">
        <div class="bloque">
          <section>
          ...
          <article class="subbloque">
            <label class="modulo_nombre">Programación de embosado</label>
          </article>         
      ...
      { echo '
        ...
        { echo '
          ...
          { if ($progLote_sttlote[$item][$subItem] == 'A')
            { echo '
              <a href="prodProgramacionBS.php?cdglote='.$progLote_cdglote[$item][$subItem].'&proceso=update">'.$_power_blue.'</a>'; }
          
            if ($progLote_sttlote[$item][$subItem] == 'D')
            { echo '
              <a href="prodProgramacionBS.php?cdglote='.$progLote_cdglote[$item][$subItem].'&proceso=delete">'.$_recycle_bin.'</a>
              <a href="prodProgramacionBS.php?cdglote='.$progLote_cdglote[$item][$subItem].'&proceso=update">'.$_power_black.'</a>'; }
