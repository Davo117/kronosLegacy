...
<html>
        ...
        $progLoteSelect = $link_mysqli->query("
          SELECT proglote.idlote,
           ...
           WHERE progbloque.cdgbloque = proglote.cdgbloque AND 
                 proglote.amplitud = ".$prodProgramacion_ancho." AND 
                 proglote.sttlote = '7'
        ...
        { $link_mysqli = conectar();
          ...
          { if (isset($_REQUEST['chk_'.$regProgLote->cdglote]))
            { $prodProgramacion_cdglote = $regProgLote->cdglote;
              ...
              $prodProgramacion_programado = (($prodProgramacion_longitud/$pdtoImpresion_corte)*$pdtoImpresion_alpaso);
              ...
              { $prodProgramacion_noop = $prodProgramacion_noopmax+1;
                ...
                $link_mysqli->query("
                  INSERT INTO prodlote
                    (cdglote, noop, cdgproducto, longitud, amplitud, peso, cdgproceso, fchprograma, programado, fchmovimiento)
                  VALUES
                    ('".$prodProgramacion_cdglote."', '".$prodProgramacion_noop."', '".$prodProgramacion_cdgimpresion."', '".$prodProgramacion_longitud."', '".$prodProgramacion_amplitud."', '".$prodProgramacion_peso."', '10', '".$prodProgramacion_fchprograma."', '".$prodProgramacion_programado."', NOW())");
              }
              else
  ...
  { // Filtrado de 
    ...
    { $pdtoDiseno_iddiseno[$idproyecto] = $regPdtoDiseno->iddiseno;
      ...
      $pdtoDiseno_ancho[$idproyecto] = $regPdtoDiseno->anchura;
 ...
 SELECT pdtojuego.cdgdiseno,
        ...
        pdtodiseno.notintas,
        pdtodiseno.alto,
        (((pdtodiseno.ancho*pdtojuego.alpaso)+pdtodiseno.empalme)) AS tabla,
    ...
    $prodLoteSelect = $link_mysqli->query("
      SELECT proglote.idlote,
       ...
       WHERE prodlote.cdgproducto = pdtoimpresion.cdgimpresion AND 
             ...
             prodlote.cdglote = proglote.cdglote AND 
    ...
    { $id_lote = 1;
      ...
      { $prodProgramacions_idlote[$id_lote] = $regProdLote->idlote;
        ...
        $prodProgramacions_calibre[$id_lote] = $regProdLote->calibre;
        ...
        $prodProgramacions_iddiseno[$id_lote] = $regProdLote->iddiseno;
        $prodProgramacions_idimpresion[$id_lote] = $regProdLote->idimpresion;
        $prodProgramacions_impresion[$id_lote] = $regProdLote->impresion;
    ...
    $progLoteSelect = $link_mysqli->query("
      SELECT proglote.idlote,
        ...
        FROM sistproceso,
             ...
             progbloque,
             proglote
       WHERE progbloque.cdgtipo = progtipo.cdgtipo AND
            (progtipo.cdgproceso = sistproceso.cdgproceso AND
             sistproceso.cdgproceso = '001') AND
            (progbloque.cdgtipo = proglote.cdgtipo) AND
    ...
    { $idlote = 1;
      ...
      { $progLotes_idlote[$idlote] = $regProgLote->idlote;
        ...
        $progLotes_calibre[$idlote] = $regProgLote->calibre;
  ...
  { $link_mysqli = conectar();
    $prodLoteSelect = $link_mysqli->query("
      ...
      WHERE (prodlote.cdglote = prodloteope.cdglote AND prodloteope.cdgoperacion = '10001') AND 
    ...
    { echo '
        <table align="center">
          <thead>
            <tr><th>Diseño</th>
              <th>Máquina</th>
              <th>Juego de cilindros</th>
              <th>Cantidad de bobinas</th>
              <th>Millares aproximados</th>
              <th>Formatos</th></tr>
          </thead>
          <tbody>';
      ...
      while ($regProdLote = $prodLoteSelect->fetch_object())
      { echo '
            <tr><td>'.$pdtoDiseno_disenos[$regProdLote->cdgdiseno].'<br>
                '.$pdtoImpresion_impresiones[$regProdLote->cdgproducto].'</td>
              ...
              <td align="right">'.number_format($regProdLote->millares,3).'</td>
              <td>
                PRO-FR-<a href="pdf/pro-fr05.php?cdgimpresion='.$regProdLote->cdgproducto.'&cdgmaquina='.$regProdLote->cdgmaquina.'&cdgjuego='.$regProdLote->cdgjuego.'&fchprograma='.$prodProgramacion_fchprograma.'&cdgfchprograma='.$prodProgramacion_cdgfchprograma.'&millares='.number_format($regProdLote->millares,3,'.','').'" target="_blank"><b>05</b></a><br>
                PRO-FR-<a href="pdf/pro-fr06.php?cdgimpresion='.$regProdLote->cdgproducto.'&cdgmaquina='.$regProdLote->cdgmaquina.'&cdgjuego='.$regProdLote->cdgjuego.'&fchprograma='.$prodProgramacion_fchprograma.'&cdgfchprograma='.$prodProgramacion_cdgfchprograma.'&millares='.number_format($regProdLote->millares,3,'.','').'" target="_blank"><b>06</b></a><br>
                PRO-FR-<a href="pdf/pro-fr07.php?cdgimpresion='.$regProdLote->cdgproducto.'&cdgmaquina='.$regProdLote->cdgmaquina.'&cdgjuego='.$regProdLote->cdgjuego.'&fchprograma='.$prodProgramacion_fchprograma.'&cdgfchprograma='.$prodProgramacion_cdgfchprograma.'&millares='.number_format($regProdLote->millares,3,'.','').'" target="_blank"><b>07</b></a><br>
                PRO-FR-<a href="pdf/pro-fr08.php?cdgimpresion='.$regProdLote->cdgproducto.'&cdgmaquina='.$regProdLote->cdgmaquina.'&cdgjuego='.$regProdLote->cdgjuego.'&fchprograma='.$prodProgramacion_fchprograma.'&cdgfchprograma='.$prodProgramacion_cdgfchprograma.'&millares='.number_format($regProdLote->millares,3,'.','').'" target="_blank"><b>08</b></a><br>
                IC-FR-<a href="../../sm_inspeccion/pdf/ic-fr01.php?cdgimpresion='.$regProdLote->cdgproducto.'&cdgmaquina='.$regProdLote->cdgmaquina.'&cdgjuego='.$regProdLote->cdgjuego.'&fchprograma='.$prodProgramacion_fchprograma.'&cdgfchprograma='.$prodProgramacion_cdgfchprograma.'&millares='.number_format($regProdLote->millares,3,'.','').'" target="_blank"><b>01</b></a></td></tr>'; }
    ...
    { echo '
        <table align="center">
          <thead>
            ...
            <tr><th><label>Tarima : No. Lote</label></th>              
              <th><label>Amplitud/Longitud</label></th>
              <th><label>Calibre/Peso</label></th>
              <th><label>Encogimiento</label></th>              
              <th><label>NoOP</label></th>
              <th><label>Impresi&oacute;n</label></th>
              <th><label>Millares</label></th>
              <th colspan="2"><label>Operaciones</label></th></tr>
          </thead>
          <tbody>';
      ...
      { echo '
            <tr align="right">
              <td align="left"><b>'.$prodProgramacions_tarima[$id_lote].' : '.$prodProgramacions_idlote[$id_lote].'</b><br>
                Ref <i>'.$prodProgramacions_lote[$id_lote].'</i></td>              
              <td>'.$prodProgramacions_amplitud[$id_lote].' <strong>mm</strong><br>'.number_format($prodProgramacions_longitud[$id_lote],2).' <strong>mts</strong></td>
              <td>'.$prodProgramacions_calibre[$id_lote].' <strong>micras</strong><br>'.number_format($prodProgramacions_peso[$id_lote],3).' <strong>kgs</strong></td>
              <td>'.$prodProgramacions_encogimiento[$id_lote].' <strong>%</strong></td>              
              <td>'.$prodProgramacions_noop[$id_lote].'</td>
              <td align="left">'.$prodProgramacions_iddiseno[$id_lote].'<br>'.$prodProgramacions_impresion[$id_lote].'</td>              
      ...
      echo '
          ...
          <tfoot>
            <tr><th colspan="9" align="right"><label for="lbl_ppgdatos">['.$numprodlotes.'] Bobinas programadas</label></th></tr>
          </tfoot>
        </table><br/>'; }
    ...
    { echo '        
        <table align="center">
          <thead>
            ...
            <tr align="left">
              <th colspan="3"><label>Tarima : No. Lote</label></th>
              <th><label>Referencia</label></th>
              <th><label>Amplitud</label></th>
              <th><label>Longitud</label></th>
              <th><label>Calibre</label></th>
              <th><label>Encogimiento</label></th>
              <th><label>Peso</label></th>
              <th><label>Millares</label></th></tr>
          </thead>
          <tbody>';
      ...
      { echo '
            <tr align="right">
              ...
              <td>'.number_format($progLotes_calibre[$idlote]).' <strong>micras</strong></td>
