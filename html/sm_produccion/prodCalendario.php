...
<html>
  ...
  { // Proceso Activo
    ...
    { // Empleado Activo
      ...
      { // Proceso Activo, Empleado Activo y Producto Activo
      ...
      { // Proceso Activo y Empleado Activo
  ...
  echo '
    ...
    <table align="center">
      <thead>
        <tr align="center"><td colspan="8">Hist&oacute;rico de producci&oacute;n</td></tr>
        <tr align="center">
  ...
  $prodCalendario_iddiamp = (($prodCalendario_diasmesprevio+1)-($prodCalendario_dia1mes));
          ...
          <td style="background:orange;">
            ...
            { echo '
                <tr align="center">
                  ...
                  <td></td>
                  <td><a href="pdf/prodCalendarioPdf.php?dsdfecha='.$prodCalendario_iddiames.'&hstfecha='.$prodCalendario_iddiames.'&cdgproceso='.$prodCalendario_cdgproceso.'&cdgempleado='.$prodCalendario_cdgempleado.'&cdgproducto='.$prodCalendario_cdgproducto.'" target="_blank">'.$png_acrobat.'</a>
				    <a href="pdf/prodMermaPdf.php?dsdfecha='.$prodCalendario_iddiames.'&hstfecha='.$prodCalendario_iddiames.'&cdgproceso='.$prodCalendario_cdgproceso.'&cdgempleado='.$prodCalendario_cdgempleado.'&cdgproducto='.$prodCalendario_cdgproducto.'" target="_blank">'.$png_pnc.'</a></td>
                </tr>'; }
  ...
  echo '
    ...
    echo '
          ...
          <td align="center" colspan="4"><strong>Rango de fechas</strong> 
            <a href="pdf/prodCalendarioPdf.php?dsdfecha='.$prodCalendario_dsdrngfecha.'&hstfecha='.$prodCalendario_hstrngfecha.'&cdgproceso='.$prodCalendario_cdgproceso.'&cdgempleado='.$prodCalendario_cdgempleado.'&cdgproducto='.$prodCalendario_cdgproducto.'" target="_blank">'.$png_acrobat.'</a>
            <a href="pdf/prodMermaPdf.php?dsdfecha='.$prodCalendario_dsdrngfecha.'&hstfecha='.$prodCalendario_hstrngfecha.'&cdgproceso='.$prodCalendario_cdgproceso.'&cdgempleado='.$prodCalendario_cdgempleado.'&cdgproducto='.$prodCalendario_cdgproducto.'" target="_blank">'.$png_pnc.'</a><br>
