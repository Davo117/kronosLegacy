      ...
      { echo '
        ...
        { if ((int)$tablero_piezas[$idfchprograma][$prodProceso_cdgproceso[$id_proceso]][$idmezcla] > 0) 
          { echo '
              ...
              <tr align="right">
                <td><strong>[ <a href="excel/prodLote.php?fchprograma='.$tablero_fchprograma[$idfchprograma].'&cdgmezcla='.$tablero_cdgmezcla[$idfchprograma][$prodProceso_cdgproceso[$id_proceso]][$idmezcla].'">'.$tablero_bobinas[$idfchprograma][$prodProceso_cdgproceso[$id_proceso]][$idmezcla].'</a> ]</strong> </td>
