    ...
    { echo '
        <table align="center">
          <thead>
            ...
            <tr><th><label for="lbl_ttltarimalote">Tarima : No. Lote</label></th>              
              <th><label for="lbl_ttlamplitud">Amplitud/Longitud</label></th>
              <th><label for="lbl_ttlespesor">Espesor/Peso</label></th>
              <th><label for="lbl_ttlencogimiento">Encogimiento</label></th>              
              <th><label for="lbl_ttlpeso">NoOP</label></th>
              <th><label for="lbl_ttlpeso">Impresi&oacute;n</label></th>
      ...
      { echo '
            <tr align="right">
              ...
              <td>'.$prodProgramacions_espesor[$id_lote].' <strong>micras</strong><br>'.number_format($prodProgramacions_peso[$id_lote],3).' <strong>kgs</strong></td>
