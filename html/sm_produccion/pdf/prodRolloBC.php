<?php
  ...
  { $pdf=new FPDF('P','mm','lbl4x2'); 
    ...
    { $pdf->AddPage();
      ...
      $pdf->Ln(1);
       //MADE by ECA
      if($regPackingList->diseno!="Comex")
      {
      ...
      $pdf->SetFont('Arial','B',10);
      $pdf->Cell(2,4,'',0,0,'L');
      $pdf->Cell(15,4,'BGN'.$regPackingList->observacion,0,1,'L');
      }
      $pdf->SetFont('Arial','',10);
      $pdf->Cell(2,4,'',0,0,'L');
      ...
      $pdf->SetFont('Arial','B',10); 
      $pdf->Cell(52,4,'',0,0,'L'); 
      $pdf->Cell(15,4,'Corte',0,1,'L');
      
      $pdf->Cell(52,4,'',0,0,'L'); 
      $pdf->SetFont('Arial','',10); 
      $pdf->Cell(28,4,'Alto',0,0,'L');
      $pdf->SetFont('Arial','B',12); 
      ...
      //$pdf->Cell(50,3,'',0,0,'R'); 
      //$pdf->Cell(46,3,date("Y-m-d H:i:s"),0,1,'R');
      $pdf->Cell(50,3,'',0,0,'R'); 
