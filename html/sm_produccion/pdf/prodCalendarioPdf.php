<?php
  ...
  { $link_mysqli = conectar();
    ...
    { $regPdtoImpresion = $pdtoImpresionSelect->fetch_object();
      ...
      $_SESSION['prodcalendario_producto'] = $regPdtoImpresion->impresion; 
    } else
    { $_SESSION['prodcalendario_producto'] = ''; }
  }  else
  { $_SESSION['prodcalendario_producto'] = ''; }
  ...
  { while ($regQuery = $prodMaquinaSelect->fetch_object())
    { $dataAux_maquina[$regQuery->cdgmaquina] = $regQuery->maquina;
      $dataAux_idmaquina[$regQuery->cdgmaquina] = $regQuery->idmaquina; }
  }
  // Fin de filtro de máquinas
    ...
    { if ($_SESSION['usuario'] == '')
      ...
      { // Proceso Activo
        ...
        { // Empleado Activo
          ...
          { // Producto Activo
            $_SESSION['prodcalendario_subtitulo'] = 'Proceso: '.$_SESSION['prodcalendario_proceso'].' / Empleado: '.$_SESSION['prodcalendario_empleado'].' / Producto: '.$_SESSION['prodcalendario_producto'];
          } else
          { // Producto Nulo
        ...
        { // Empleado Nulo
          if ($_SESSION['prodcalendario_producto'] != '')
          { // Producto Activo
            $_SESSION['prodcalendario_subtitulo'] = 'Proceso: '.$_SESSION['prodcalendario_proceso'].' / Producto: '.$_SESSION['prodcalendario_producto']; 
          } else
          { // Producto Nulo
      ...
      { // Proceso Nulo
        ...
        { // Empleado Activo
          if ($_SESSION['prodcalendario_producto'] != '')
          { // Producto Activo
            $_SESSION['prodcalendario_subtitulo'] = 'Empleado: '.$_SESSION['prodcalendario_empleado'].' / Producto: '.$_SESSION['prodcalendario_producto'];
          } else
          { // Producto Nulo
        ...
        { // Empleado Nulo
          if ($_SESSION['prodcalendario_producto'] != '')
          { // Producto Activo
            $_SESSION['prodcalendario_subtitulo'] = 'Producto: '.$_SESSION['prodcalendario_producto'];
          } else
          { // Producto Nulo
  ...
  { while ($regProdOperacion = $prodOperacionSelect->fetch_object())
    { $prodCalendario_operacion[$regProdOperacion->cdgoperacion] = $regProdOperacion->operacion; }
  }
  ...
  { while ($regProdMaquina = $prodMaquinaSelect->fetch_object())
    { $prodCalendario_maquinas[$regProdMaquina->cdgmaquina] = $regProdMaquina->maquina; }
  }  
  ...
  { while ($regPdtoImpresion = $pdtoImpresionSelect->fetch_object())
    { $prodCalendario_productos[$regPdtoImpresion->cdgimpresion] = $regPdtoImpresion->impresion; }
  }
                 ...
                 SUBSTR(prodbobinaope.fchmovimiento,1,10) = '".$regProdCalendario->fchmovimiento."' AND
                    ...
                    { 
                      ...
                      { $pdf->SetFont('arial','B',5); 
                        ...
                        $pdf->Cell(53,4,$prodCalendario_maquinas[$regProdBobina->cdgmaquina],1,0,'L');
                      ...
                      $pdf->Cell(4,4,'',0,0,'C');
                      $pdf->Cell(126,4,'Operacion: '.$prodCalendario_operacion[$regProdOperacion->cdgoperacion],0,0,'L');
                ...
                { while($regProdOperacion = $prodOperacionSelect->fetch_object())
                 ...
                 SUBSTR(prodrolloope.fchmovimiento,1,10) = '".$regProdCalendario->fchmovimiento."' AND
                    ...
                    { $pdf->SetFont('arial','B',8);
                      ...
                      $pdf->SetFont('arial','B',8); 
                      $pdf->Cell(4,4,'',0,0,'C');
                      $pdf->Cell(73,4,'Operacion: '.$prodCalendario_operacion[$regProdOperacion->cdgoperacion],0,0,'L');
                ...
                { $id_fecha = 0;
                 ...
                 SUBSTR(prodloteope.fchmovimiento,1,10) = '".$rptProduccion_fchmovimiento[$id_fecha]."' AND
                    ...
                    { $pdf->SetFont('arial','B',8);
                      ...
                      $pdf->Cell(4,4,'',0,0,'C');
                      $pdf->Cell(63,4,'Operacion: '.$prodCalendario_operacion[$regOperacion->cdgoperacion],0,0,'L');
