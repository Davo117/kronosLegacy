<?php
  ...
  { $regPdtoImpresion = $pdtoImpresionSelect->fetch_object();
    ...
    $_SESSION['prodrollo_producto'] = $regPdtoImpresion->impresion;    
  ...
  { class PDF extends FPDF
    { function Header()
      { if ($_SESSION['usuario'] == '')
        ...
        $this->Cell(0,4,'Inventario de rollos por producto '.$_SESSION['prodrollo_producto'],0,1,'R');
        ...
        $this->Cell(20,4,'Rollo',0,0,'L',true);
    ...
    { if ($prodDocumento_impresion == '')
      ...
      $pdf->Cell(40,4,$regProdSubLote->cdgrollo,1,0,'R');
