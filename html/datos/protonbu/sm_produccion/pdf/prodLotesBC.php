<?php
  ...
  require('../../fpdf/fpdflbl.php');
    ...
    SELECT proglote.lote,
      ...
      prodlote.amplitud,
      prodlote.peso,
    ((prodlote.longitud*pdtoimpresion.alpaso)/pdtoimpresion.corte) AS cantidad,
    ...
    WHERE prodlote.cdgproducto = '".$_GET['cdgproducto']."' AND 
  ...
  { $pdf=new FPDF('P','mm','lbl4x2'); 
    ...
    { $pdf->AddPage();
      ...
      $pdf->Cell(2,4,'',0,0,'L');
      $pdf->Cell(98,4,$regPackingList->mezcla,0,1,'L');       
