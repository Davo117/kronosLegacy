                ...
                { while($regProdOperacion = $prodOperacionSelect->fetch_object())
                 ...
                 SUBSTR(prodbobinaope.fchmovimiento,1,10) = '".$regProdCalendario->fchmovimiento."' AND
                    ...
                    { 
                      ...
                      $pdf->Cell(4,4,'',0,0,'C');
                      $pdf->Cell(126,4,'Operacion: '.$prodCalendario_operaciones[$regProdOperacion->cdgoperacion],0,0,'L');
                ...
                { $id_fecha = 0;
                  ...
                  { $link_mysqli = conectar();
                    $prodLoteSelect = $link_mysqli->query("
                      ...
                      ((proglote.longitud*pdtoimpresion.alpaso)/pdtoimpresion.corte) AS millares_origen,
                        prodlote.longitud,
                      ((prodlote.longitud*pdtoimpresion.alpaso)/pdtoimpresion.corte) AS millares,
                 ...
                 SUBSTR(prodloteope.fchmovimiento,1,10) = '".$rptProduccion_fchmovimiento[$id_fecha]."' AND
                    ...
                    { $pdf->SetFont('arial','B',8);
                      ...
                      $pdf->Cell(4,4,'',0,0,'C');
                      $pdf->Cell(63,4,'Operacion: '.$prodCalendario_operaciones[$regOperacion->cdgoperacion],0,0,'L');
