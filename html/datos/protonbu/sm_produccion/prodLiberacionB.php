    ...
    { $prodBobina_cdgbobina = trim($_POST['text_bobina']);
      ...
      { $link_mysqli = conectar();
        $prodBobinaSelect = $link_mysqli->query("
          ...
          AND ((prodbobina.cdgbobina = '".$prodBobina_cdgbobina."')
            OR (CONCAT(prodlote.noop,'-',prodbobina.bobina) = '".$prodBobina_cdgbobina."'))
              ...
              { $prodBobina_amplitud = $_POST['text_amplitud'];
                ...
                { $prodBobina_peso = $_POST['text_peso']; 
                  ...
                  $link_mysqli->query("
                    ...
                    VALUES
                      ('".$prodBobina_cdgbobina."', '30007', '".$_SESSION['cdgusuario']."', '00001', '".$fchoperacion."', NOW())");
                  ...
                  { $msg_alert .= 'Operacion de liberacion en Bobina, '.$prodBobina_noop.'-'.$prodBobina_bobina.', realizada. \n';
                    ...
                    $link_mysqli->query("
                      ...
                      VALUES
                        ('".$prodBobina_cdgbobina."', '37', '".$prodBobina_infolongitud."', '".$prodBobina_infoamplitud."', '".$prodBobina_infopeso."', NOW())");                 

                    if ($link_mysqli->affected_rows > 0) 
                    { $msg_alert .= 'Proceso de liberacion en Bobina, '.$prodBobina_noop.'-'.$prodBobina_bobina.', registrado. \n'; 
