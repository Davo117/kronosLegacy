  ...
  { if (strlen($progLote_lote) > 0)
    { $link_mysqli = conectar();
      ...
      {	$regProgLote = $progLoteSelect->fetch_object();
        ...
        { $aviso = 'El lote '.$progLote_idlote.' NO fue actualizado (Posiblemente liberado).'; }
      }
      else
    ...
    { for ($idlote = 1; $idlote <= $idslote[$idtarima]; $idlote++)
      ...
      echo '
          <tr align="right">
            ...
            <th colspan="4">'.number_format($progLote_sumapeso[$idtarima],3).' Kgs</th>
            <td colspan="4"></td></tr>';
