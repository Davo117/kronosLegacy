...
<html>
  ...
  { $sistModulo_permiso = sistPermiso($sistModulo_cdgmodulo, $_SESSION['cdgusuario']);     
    ...
    { $pdtoTintas_idtinta[$idTinta] = $regPdtoTinta->idtinta;
      ...
      $pdtoTintas_cdgproveedor[$idTinta] = $regPdtoTinta->cdgproveedor;
      $pdtoTintas_cdghex[$idTinta] = $regPdtoTinta->cdghex;
      $pdtoTintas_cdgtinta[$idTinta] = $regPdtoTinta->cdgtinta;
      $pdtoTintas_stttinta[$idTinta] = $regPdtoTinta->stttinta; 
  ...
  echo '
    <form id="frm_pdtotinta" name="frm_pdtotinta" method="POST" action="pdtoTinta.php">
      <table align="center">
        <thead>
      ...
      <table align="center">
        <thead>
          <tr align="left">
            ...
            <th><label for="lbl_ttlcdghex">Pantone<br/>(*hex)</label></th>
  ...
  { for ($idTinta=1; $idTinta<=$numTintas; $idTinta++)
    { echo '
          <tr align="center">
            ...
            <td align="left">'.$pdtoTintas_cdgproveedor[$idTinta].'</td>
            <td bgcolor="'.$pdtoTintas_cdghex[$idTinta].'">&nbsp;</td>';

      if ((int)$pdtoTintas_stttinta[$idTinta] > 0)
      { echo '
            <td><a href="pdtoTinta.php?cdgtinta='.$pdtoTintas_cdgtinta[$idTinta].'">'.$png_search.'</a></td>            
            <td><a href="pdtoTinta.php?cdgtinta='.$pdtoTintas_cdgtinta[$idTinta].'&proceso=update">'.$png_power_blue.'</a></td>'; }
      else
       { echo '
            <td><a href="pdtoTinta.php?cdgtinta='.$pdtoTintas_cdgtinta[$idTinta].'&proceso=delete">'.$png_recycle_bin.'</a></td>            
            <td><a href="pdtoTinta.php?cdgtinta='.$pdtoTintas_cdgtinta[$idTinta].'&proceso=update">'.$png_power_black.'</a></td>'; }
