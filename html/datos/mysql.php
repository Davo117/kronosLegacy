<?php session_start();
  ...
  function conectar()
  { return new mysqli('localhost', 'kronos', 'gl123', 'proton'); }
      ...
      <section id="modulo_barraup">
        ...
        <article id="menu_nombre">
          ...
          <label><a href="../sm_produccion/subMenuTermo.php">Termoencogible</a> | 
            ...
            <a href="../sm_produccion/prodOperaciones.php">Histórico de operaciones</a></label> | 
  ...
  function m3nu_sistema()
  { echo'
      <section id="modulo_barraup">
        <a href="../main.php"><img id="imagen_menu" src="../img_sistema/game_pad.png"/></a>
        <article id="menu_nombre">
          <label><b>Sistema</b></label><br>
          <label><a href="../sm_sistema/mapaEstado.php">Mapa</a> | 
          <label><a href="../sm_sistema/sistPerfil.php">Perfiles</a> | 
          <label><a href="../sm_sistema/sistUsuario.php">Usuarios</a> | 
          <label><a href="../sm_sistema/sistPassword.php">Cambio de password</a></label>
        </article>
      </section>'; }      
