...
<?php
  ...
  { $sistModulo_permiso = sistPermiso($sistModulo_cdgmodulo, $_SESSION['cdgusuario']);
    ...
    { $regPdtoImpresion = $pdtoImpresionSelect->fetch_object();
      ...
      $inspGBRRollo_producto = $regPdtoImpresion->impresion;
      $inspGBRRollo_cdgproducto = $regPdtoImpresion->cdgimpresion;
      ...
      { if (substr($sistModulo_permiso,0,3) == 'rwx')
        { $link->query("
            UPDATE prodrollo
               SET obs = CONCAT('".date('Y-m-d H:i:s')."\nOperación de revisión deshecha por ".$_SESSION['usuario']."\n', obs),
                   sttrollo = '1'
      ...
      <div class="bloque">
        <article class="subbloque">
          <label class="modulo_listado">Producto <b><a href="inspBuscador.php?cdgproducto='.$inspGBRRollo_cdgproducto.'">'.$inspGBRRollo_producto.'</a></b></label>
        </article>
        <label class="modulo_listado"><b>'.$nRollos.'</b> Rollos revisados</label>
      ...
      { echo '
        ...
        { echo '
            <tr><td><b>'.$inspProdRollo_noop[$item].'</b></td>
              ...
              <td align="center"><a href="inspGBRRollo.php?cdgrollo='.$inspProdRollo_cdgrollo[$item].'&cdgproducto='.$_GET['cdgproducto'].'">'.$_button_blue_repeat.'</a></td></tr>'; }
