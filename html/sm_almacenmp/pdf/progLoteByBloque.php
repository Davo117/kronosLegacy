<?php
  ...
  { $id_tarima = 1;
	...
	{ function Header()
      ...
      $this->Cell(20,4,'Micras',0,0,'L',true);
      $this->Cell(20,4,'Encogimiento',0,0,'L',true);
      $this->Cell(20,4,'Peso (Kg)',0,0,'L',true);
      $this->Cell(20,4,'Rendimiento',0,0,'L',true);
  ...
  { $progLotePdf_longitudes = 0;
    ...
    { $pdf->Cell(10,5,$progLotePdf_idlote[$id_tarima][$id_lote].' ',0,0,'R');      
      ...
      $pdf->Cell(20,5,$progLotePdf_espesor[$id_tarima][$id_lote].' ',0,0,'R');
      $pdf->Cell(20,5,$progLotePdf_encogimiento[$id_tarima][$id_lote].' ',0,0,'R');
      $pdf->Cell(20,5,number_format($progLotePdf_peso[$id_tarima][$id_lote],3).' ',0,0,'R');
      $pdf->Cell(20,5,number_format((($progLotePdf_longitud[$id_tarima][$id_lote]/$progLotePdf_peso[$id_tarima][$id_lote])*($progLotePdf_amplitud[$id_tarima][$id_lote]/1000)),3).' ',0,0,'R');
      $pdf->Cell(5,5,' ',1,0,'R');
      $pdf->Ln();
      ...
      $progLotePdf_rendimientos += number_format((($progLotePdf_longitud[$id_tarima][$id_lote]/$progLotePdf_peso[$id_tarima][$id_lote])*($progLotePdf_amplitud[$id_tarima][$id_lote]/1000)),3);
    }
    ...
    $pdf->Cell(65,4,'',0,0,'R',true);
    $pdf->Cell(20,4,number_format($progLotePdf_pesos,3).' ',0,0,'R',true);
    $pdf->Cell(20,4,number_format(($progLotePdf_rendimientos/$numlotes[$id_tarima]),3).' ',0,0,'R',true);
