<?php
  ...
  $pdf->Cell(134.5,4.15,'',0,0);
  $pdf->Cell(30,4.15,utf8_decode('No. Solicitud de mantenimiento'),0,0,'R');
  $pdf->Cell(0.5,4.15,'',0,1,'R',true);
  
  $pdf->Line(175.5,$pdf->GetY(),205,$pdf->GetY());
  
  $pdf->SetFont('Arial','B',10);
  $pdf->Cell(40,8.3,utf8_decode('Reporte'),0,1,'L');

  for ($idLn = 0; $idLn<=42; $idLn++)
  { $pdf->Ln(4.15);  
    $pdf->Line(20,$pdf->GetY(),205,$pdf->GetY()); }
