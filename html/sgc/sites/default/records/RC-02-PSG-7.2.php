<?php
	...
	{ // Cabecera de página
		...
		{ $this->SetFont('Arial','B',8);
		  ...
		  $this->Cell(0.5,4,'',0,1,'R',true);
			...
			$this->Cell(125.5,4,'',0,0,'R');
			$this->Cell(75,4,utf8_decode('RC-02-PSG-7.2'),0,1,'L');
			$this->Cell(125.5,4,'',0,0,'R');
  ...
  $pdf->SetFont('Arial','',8);
  $pdf->MultiCell(0,5,utf8_decode('Anexo a este registro debe encontrarse una impresión del diseño donde se aprecien las medidas indicadas y el desarmado en capas del diseño con una impresión por cada capa de tinta con el orden en que debe ser impreso.'));
  
  ////////////////////////////////////////////////
	$pdf->Output('RC-02-PSG-7.2.pdf', 'D');
?>