<?php
  require('fpdf/fpdf.php');
    ...
    { if (file_exists('../images/logo.jpg')==true) 
      ...
      $this->Cell(75,4,utf8_decode('Diagrama de flujo Mantenimiento'),0,1,'L');

      $this->SetFont('Arial','B',8);
      $this->Cell(125,4,utf8_decode('Código'),0,0,'R');
      $this->Cell(0.5,4,'',0,0,'R',true);
      $this->SetFont('Arial','I',8);
      $this->Cell(75,4,utf8_decode('A-01-PSG-6.3'),0,1,'L');
      ...
      $this->Cell(0.5,4,'',0,0,'R',true);
      $this->SetFont('Arial','I',8);
      $this->Cell(75,4,utf8_decode('Mayo 14, 2014'),0,1,'L');

      $this->SetFont('Arial','B',8);
      $this->Cell(125,4,utf8_decode('Responsable'),0,0,'R');
      $this->Cell(0.5,4,'',0,0,'R',true);
      $this->SetFont('Arial','I',8);
      $this->Cell(75,4,utf8_decode('Jefes de Mantenimiento y TI'),0,1,'L'); }
  ...
  if (file_exists('../images/A-01-PSG-6.3.png')==true) 
  { $pdf->Image('../images/A-01-PSG-6.3.png',20,35,175,0); }
   ...
   $pdf->SetFont('Arial','',8);
   $pdf->Cell(30,4,utf8_decode('Infraestructura'.$pdf->GetY()),0,1,'L');
