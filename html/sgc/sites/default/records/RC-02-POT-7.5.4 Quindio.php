...
$pdf->Cell(0.5,4,'',0,0,'R',true);
$pdf->Cell(75.9,4,utf8_decode('Hoja de Inspección Presencia Molecular Quindio'),0,1,'L');
$pdf->Cell(127,4,'',0,0,'R');
$pdf->Cell(0.5,4,'',0,0,'R',true);
$pdf->Cell(75.9,4,utf8_decode('RC-02-POT-7.5.4 Quindio'),0,1,'L');
$pdf->Cell(127,4,'',0,0,'R');
$pdf->Cell(0.5,4,'',0,0,'R',true);
...
$pdf->Cell(27,4,utf8_decode('Número de bobina'),0,0,'L');
$pdf->Cell(43,4,'',0,1,'R',true);
...
$pdf->Cell(30,12,utf8_decode('Lectura de Molecula'),0,1,'L');
$pdf->Cell(30,12,utf8_decode('Lectura de Molécula'),0,1,'L');
...
$pdf->Output('RC-02-POT-7.5.4 Quindio.pdf', 'D');
?>