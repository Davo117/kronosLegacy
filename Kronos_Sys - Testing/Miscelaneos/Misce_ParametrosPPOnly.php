...
<head>
<title>Parámetros Por Procesos| Misceláneos</title>
...
include("Controlador_Misce/crud_PPOnly.php");
?>
<center>
<div id="form">
<form method="POST" name="formulary" id="formulary">
<p id="titulo">Parámetros Por Procesos</p>
<p>Nombre:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Tipo:</p>

<p>
	 <input type="text" name="parametroName" value="" size="20" placeholder="nombre sin espacios" required> &nbsp; &nbsp;
  <select  type="POST" name="Tipo"> 
 ...
 <?php
	...
	?>
	<button type="submit" class="botonPerson3" style="transform:translate(-400px,-50px);" name="savePP">Guardar</button>
	<?php
?>
</form>
...
<?php
include("Controlador_Misce/showParametrosPPOnly.php");
?>
</table>
</div>
</center>
