...
$MySQLi= new mysqli('localhost', 'saturno','gl123','saturno');
...
while ($row=$SQL->fetch_array()) {
  ...
  echo $contador."\n";
    $no="PAM".$numero;
    //$MySQLi->query("INSERT into juegoparametros(identificadorJuego,nombreparametro,numParametro,baja,requerido,leyenda,placeholder) values ('".$row['identificadorJuego']."','observaciones','".$no."','1','0','Observaciones','detalles')");
    $contador++;
  }
