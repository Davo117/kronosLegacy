        ...
        <form method="POST" name="formulary" id="formulary" role="form">
          <div class="panel panel-success">
            ...
            <div class="panel-body">
              <div class="panel panel-default col-lg-8 col-md-4 col-xs-4">
             <div class="col-xs-4  col-md-4 col-lg-4" id="contenedorreal">
              <!--
...
<label for="familia">Familia</label><br>
  ...
  <select  name="familia" required="TRUE" class="selectpicker show-menu-arrow form-control" <?php if (isset($_GET['edit'])) {  echo "disabled"; } ?>> 
...
<input type="number" step="any" max="100" min="1" placeholder="Cantidad de códigos por generar" class="form-control" name="mountcodes" style="float:right;" required value="<?php if(isset($_GET['edit'])) echo $gg['consec']; ?>" ></div> <br>
...
if(isset($_GET['edit']))
{
  ...
  ?>
  <button style="float:right;" class="btn btn-primary" type="submit" name="update">Actualizar</button>
  </div></div></div></form>
...
{
  ?>                    <!-- BOTON PARA GENERAR CODIGOS   --> <br> <div style="float:left;">
...
<div class="panel panel-default col-lg-8 col-md-4 col-xs-4">
        ...
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            $lstIn=$mysqli->query("SELECT*FROM obelisco.pzcodes group by codigoB  order by fecha_alta desc limit 100");

            ?>
            <th>Códigos</th><th>Fecha</th><th>Serie</th><th>Modificar</th>
            <tr>
              ...
              while($row=$lstIn->fetch_array())
              {
                ...
                <!--TRAE LA SERIE Y GENERA EL REPORTE EN PDF -->
                 ...
                 <td><?php echo $row['fecha_alta'];?></td><td><?php echo $row['cdglist'];?></td>
