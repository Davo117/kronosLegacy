...
$(document).on('keypress', '#operador', function(e) {
           ...
           if(code==13){
              ...
              $.ajax({
                type: "POST",
                url: "controlador_almacen/crud_salidas.php",
                data: "c="+cantidad+"&p="+producto+"&n="+nombreProducto+"&ope="+operador+"&cB="+codigoB,
                dataType: "html",
                error: function(){
                  alert("error petición ajax");
                },
           ...
           if(code==13){
            ...
            else
            {
              ...
              $.ajax({
                type: "POST",
                url: "controlador_almacen/crud_salidas.php",
                data: "c="+cantidad+"&p="+producto+"&n="+nombreProducto+"&h="+hascode+"&pr="+precio+"&ope="+operador,
                dataType: "html",
                error: function(){
                  alert("error petición ajax");
                },
            ...
            $(document).on('keypress', '#unidades', function(e) {
             ...
             if(code==13){
              ...
              $.ajax({
                type: "POST",
                url: "controlador_almacen/crud_salidas.php",
                data: "c="+cantidad+"&p="+producto+"&n="+nombreProducto+"&h="+hascode+"&pr="+precio+"&un="+unidades+"&ope="+operador,
                dataType: "html",
                error: function(){
                  alert("error petición ajax");
                },
