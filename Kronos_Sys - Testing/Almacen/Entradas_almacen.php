          ...
          $(document).on('keypress', '#cdgproducto', function(e) {
            ...
            if(code==13){
              ...
              if (proveedor == proveedorCB) {
                ...
                alert("El código de barras no correspende a este proveedor.");
              }  
            }
          });    
                ...
                if(code==13){
                  ...
                  $.ajax({
                    type: "POST",
                    url: "controlador_almacen/crud_almacen.php",
                    data: "c="+cantidad+"&p="+producto+"&n="+nombreProducto+"&h="+hascode+"&cB="+codiguin,
                    dataType: "html",
                    error: function(){
                      alert("error petición ajax");
                    },
          ...
          $(document).on('keypress', '#lote', function(e) {
           ...
           if(code==13)
           {
            ...
            $.ajax({
              type: "POST",
              url: "controlador_almacen/crud_almacen.php",
              data: "c="+cantidad+"&p="+producto+"&n="+nombreProducto+"&h="+hascode+"&pr="+precio+"&cB="+codiguin+"&nlote="+lote+"&fechaIn="+fechaIn,
              dataType: "html",
              error: function(){
                alert("error petición ajax");
              },
          ...
          $(document).on('keypress', '#unidades', function(e) {
           ...
           if(code==13){
            ...
            $.ajax({
              type: "POST",
              url: "controlador_almacen/crud_almacen.php",
              data: "c="+cantidad+"&p="+producto+"&n="+nombreProducto+"&h="+hascode+"&pr="+precio+"&un="+unidades+"&cB="+codiguin,
              dataType: "html",
              error: function(){
                alert("error petición ajax");
              },
