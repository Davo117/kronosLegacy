...
";
	...
	//Realizamos la consulta
	 $SQL =$MySQLiconn->query("INSERT INTO obelisco.productosCK(producto,unidad,hasprice,criterio,max,min,class,place,lote) VALUES('".$elemento."','".$unidad."','".$hasprice."','".$criterio."','".$max."','".$min."','".$clase."','".$place."','".$lote."')");
...
$SQL = $MySQLiconn->query("UPDATE obelisco.productosCK SET  unidad='$unidad', hasprice='$hasprice',  place='$place',lote='$lote' WHERE producto='".$_GET['edit']."'");
