    ...
    <nav class="navbar navbar-default navbar-fixed-top bg-secondary" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="#" data-toggle="collapse" class="menu_opcion" data-target="#submenu-2" <?php if($buf=='/var/www/html/Saturno v0.6/'.$nombreSistema.'/Almacen'){ echo "Style='background-color:#E8EDFF'";} ?>><img src="../pictures/archive.png" width="40">Control de almacén<i class="fa fa-fw fa-angle-down pull-right"></i></a>
                    <ul id="submenu-2" class="collapse">
                          <li><a href="../Almacen/Entradas_almacen.php"><i class="fa fa-angle-double-right"></i>Entradas de almacén</a></li>
                        <li><a href="../Almacen/Salidas_almacen.php"><i class="fa fa-angle-double-right"></i>Salidas de almacén</a></li>
                         <li><a href="../Almacen/layout_almacen.php"><i class="fa fa-angle-double-right"></i>Ubicación</a></li>
                         <li><a href="../Almacen/getcodealmacen.php"><i class="fa fa-angle-double-right"></i>Códigos de barras</a></li>
                         <li><a href="../Almacen/inventario_Materia_Prima.php"><i class="fa fa-angle-double-right"></i>Inventario</a></li>
                ...
                <li>
                    <a href="#" data-toggle="collapse" data-target="#submenu-16" class="menu_opcion" <?php if($buf=='/var/www/html/Saturno v0.6/'.$nombreSistema.'/Proveedores'){ echo "Style='background-color:#E8EDFF'";} ?>>
                   <img src="../pictures/user_group.png" width="40">Proveedores<i class="fa fa-fw fa-angle-down pull-right"></i></a>

                    
                </li>
                <li>
                    <a href="#" data-toggle="collapse" data-target="#submenu-17" class="menu_opcion" <?php if($buf=='/var/www/html/Saturno v0.6/'.$nombreSistema.'/Servicios'){ echo "Style='background-color:#E8EDFF'";} ?>>
