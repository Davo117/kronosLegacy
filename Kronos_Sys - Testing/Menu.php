...
<div class="container" >
	<div class="col-xs-6"><a href="../Inventario/"><img style="" src="pictures/logo-labro.png" class="img-responsive"></a><h3 class="display-4">Sistema de control de producción (v1.7)</h3>
...
<button class="btn btn-sucess"><img class="img-rounded" width="40" src="pictures/plus.png"></button>
	...
	<div class="col-xs-6" >
				...
				<a class="btn btn-info btn-block" href="Produccion/Produccion_control.php?Manga Termoencogible" role="button" href="Produccion/Produccion_control.php?tipo=Termoencogible" style="float:left;"><IMG src="pictures/gerarBig.png" style="margin: 0 auto" class="img-responsive"></IMG>
					...
					<a class="btn btn-info btn-block" href="Empaque/Empaque_Ensamble.php" role="button" href="Empaque/Empaque_inventario.php" style="float:left;"><IMG style="margin: 0 auto" src="pictures/Almacen.png" class="img-responsive"><p class="lead">Almacén</p></a>
				</div>
</div>
