...
$resultado = $MySQLiconn->query("SELECT * FROM productoscliente where baja=1 order by IdProdCliente desc");
while ($rows = $resultado->fetch_array()) {
print("<tr>");
?>
<td>&nbsp &nbsp<a href="?edit=<?php echo $rows["IdProdCliente"]; ?>"" ><IMG src="../pictures/modificarproducto.png" title='Modificar'></a>  
    <a href="?del=<?php echo $rows["IdProdCliente"]; ?>"><IMG src="../pictures/deletProducto.png" title='eliminar'></a></td>
<?php
