...
<div class="col-xs-3">
<label for="<?php echo $rex['nombreparametro']?>"><?php echo $rex['leyenda'] ?></label>
<input style="float:left;" type="text" name="<?php echo $rex['nombreparametro'] ?>" value="<?php if(isset($_GET['edit'])){ echo $getROW[$valiu]; if($rex['nombreparametro']=='millaresPorRollo' || $rex['nombreparametro']=='porcentajeMPR' || $rex['nombreparametro']=='observaciones'){  }else if($inProd==0){}else{ echo '"readonly="true';}} ?>"
    size="18" placeholder="<?php echo $rex['placeholder'] ?>" class="form-control" >
</div>
