...
if(isset($_POST['save']))
{
	...
	$rau = $result->fetch_array();if(isset($_POST['pretederminados']))
	$predeterminados;
...
$predeterminados=0;
	...
	//Realizamos la consulta
	 $SQL =$MySQLiconn->query("INSERT INTO producto(codigo,descripcion, tipo,consPre) VALUES('$codigo','$descripcion','$tipo','$predeterminados')");
