...
if(isset($_GET['Buscar'])){
	...
	<div class='panel-body'>";
		...
		<?php
		$SQL=$MySQLiconn->query("SELECT noop,noProceso, codigo as id,tipo,proceso from tbcodigosbarras where codigo='".$_GET['Buscar']."'");
		...
		{
			?>
		<a  style="float:right;opacity: 50%" class="btn btn-default"  title="No se puede deshacer porque existen movimientos posteriores"><img class="image-responsive" width="32" height="28" src="../pictures/redo.png"></a>
		<?php
		}
		}
		else if($idre==$idin)
