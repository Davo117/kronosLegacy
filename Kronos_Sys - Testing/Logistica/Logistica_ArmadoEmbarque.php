...
$dato=$MySQLiconn->query("SELECT cantidadConfi, surtido from $confirProd where enlaceEmbarque='".$getconfir['idEmbarque']."' && idConfi='".$getconfir['idorden']."'");

$total=$dato->fetch_array();

$sucu=$MySQLiconn->query("SELECT nombresuc FROM $tablasucursal where idsuc=".$getconfir['sucEmbFK'].";");
$rowSuc=$sucu->fetch_array();

$prod=$MySQLiconn->query("SELECT descripcionImpresion FROM $impresion where id=".$getconfir['prodEmbFK'].";");
...
<div class="fields col-xs-3 "><p><b>Terminar Embarque</b></p>
...
<p><b><?php echo $rowSuc['nombresuc']; ?></b>
</p></div>

<div class="fields col-xs-5" ><p>Producto</p>
<p><b><?php echo $rowProd['descripcionImpresion']; ?></b>
</p></div>
...
<?php
$productillo=$getconfir['prodEmbFK'];
