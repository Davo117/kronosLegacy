...
<div  class="col-xs-3"><p>Folio</p>
<p><b><?php echo $r['folio']; ?></b></p>
</div>

<div  class="col-xs-3"><p>Código</p>
<p><b><?php echo $r['codigo']; ?></b></p>
</div>

<div  class="col-xs-3"><p>Tipo</p>
...
<div  class="col-xs-3" style="clear: left;"><p>Fecha Documento</p>
...
<center>
<form method="post" name="formulary" id="formulary" class="col-xs-12">
<?php
