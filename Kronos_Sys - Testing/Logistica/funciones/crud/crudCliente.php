...
if(isset($_GET['eli'])){ 
	...
	$MySQLiconn->query("UPDATE $tablaconcli SET bajaconcli=0 WHERE idcliFK='".$_GET['eli']."'");
	$MySQLiconn->query("UPDATE $tablasucursal SET bajasuc=0 WHERE idcliFKS='".$_GET['eli']."'");
