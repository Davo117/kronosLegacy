...
<div class="table-responsive col-xs-10">
	<div class="col-xs-3"><a href='#' onclick='verificar();'><img class="img-responsive" width="30" height="30" style="float:right;" src="../pictures/trash.png" ></a></div>
	<div class="col-xs-4"><input type="text"  name="caja_busqueda" class="form-control" id="caja_busqueda" onkeyup="tratar(this.value)"	placeholder="Búsqueda General" style="border-style:border: 2px solid; border-color: #31B0D5; border-radius: 5px;" value="<?php echo $_SESSION['busqueda']; ?>">
	</div>
...
<script src="../css/menuFunction.js"></script>
<script> 
$(tratar(''));

window.onload= function(){
document.getElementById('caja_busqueda').value='<?php echo $_SESSION["busqueda"]; ?>';
tratar('<?php echo $_SESSION["busqueda"]; ?>');
};

function verificar(){
	//var valor=document.getElementById('caja_busqueda').value;
	//alertify.notify("El valor es:"+ valor);
