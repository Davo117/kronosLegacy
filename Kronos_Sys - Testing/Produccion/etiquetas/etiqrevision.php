...
if($procesoSiguiente!="")
{
   $pdf->SetFont('Arial','',10);
      ...
      $SIC=$MySQLiconn->query("SELECT amplitud from `tbpro".$procesoAnterior."` where noop  like '".$regPackingList->noop."' and tipo='$tipo'");
      if(!$SIC)
      {
...
/*
$divisiones=1;
//divisiones de registros que tendra esta etiqueta,en base al proceso siguiente
