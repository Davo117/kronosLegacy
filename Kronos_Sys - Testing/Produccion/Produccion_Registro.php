                    ...
                    else if($rex['nombreparametro']=="suaje")
                    {
                        ...
                        <div class="col-xs-3">
                         ...
                         $Sel=$MySQLiconn->query("
                            ...
                            <SELECT class="form-control" required="true" name="<?php echo $rex['nombreparametro'] ?>" id="<?php echo $rex['nombreparametro'] ?>" >
                                <option value="">---</option>
                                <?php
                                while($op=$Sel->fetch_array())
                                {
                          ...
                          if($rex['nombreparametro']=="suaje")
                          {
                            ...
                            <div class="col-xs-3">
                             ...
                             $Sel=$MySQLiconn->query("
                                ...
                                <SELECT class="form-control" required="true" id="<?php echo $rex['nombreparametro'] ?>" name="<?php echo $rex['nombreparametro'] ?>" >
                                    <option value="">---</option>
                                    <?php
                                    while($op=$Sel->fetch_array())
                                    {
