...
$result=$MySQLiconn->query("SELECT noLote,longitud,unidades,anchura,referencia,peso,tipo from lotestemporales where baja=1");
?>
<p id="leyendalotes" style="text-align:justify;width:200px;margin-right:310px;">Lotes Seleccionados  (<?php echo $result->num_rows;?>)</p><br>
