<?php
echo "<th>&nbsp Opciones &nbsp</th> <th>ID</th> <th>Cantidad</th> <th>Referencia</th>";
...
<tr>
<td><a href="?activar=<?php echo $rows["idReq"]; ?>" onclick="return confirm('<?php echo ("Deseas ACTIVAR el Requerimiento: ".$rows["ordenReqFK"]." ?"); ?>'); " ><IMG src="funciones/img/activo.png" title='Activar'></a> 
&nbsp
<a href="?eli=<?php echo $rows["idReq"]; ?>" onclick="return confirm('<?php echo ("Deseas ELIMINAR el Requerimiento: ".$rows["ordenReqFK"]." ?"); ?>');" ><IMG src="funciones/img/deleteDef.png" title='Eliminar'></a></td>



<?php
//Traemos la tabla y la imprimimos debidamente donde pertenece 
echo; echo "<td title='ID'> &nbsp  "; echo $rows["idReq"]; echo " &nbsp  </td>
