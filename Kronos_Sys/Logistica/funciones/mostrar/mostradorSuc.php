...
&nbsp; &nbsp;
<a href="?comboconsuc=<?php echo $rows["idsuc"]; ?>"><IMG src="funciones/img/contacto.png" title='Contacto Sucursal'></a>
&nbsp;
<a href="?comboOC=<?php echo $rows["idsuc"]; ?>"><IMG src="funciones/img/ordencom.png" title='Orden Compra'></a>
&nbsp;
<a href="?comboembar=<?php echo $rows["idsuc"]; ?>"><IMG src="funciones/img/embarque.png" title='Embarques'></a>
 </td>
<?php
