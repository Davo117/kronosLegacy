...
if(isset($_POST['save'])){
	...
	$SQL = $MySQLiconn->query("SELECT nombresuc FROM $tablasucursal WHERE idsuc=".$idfk);
	$get = $SQL->fetch_array();
 	$SQL =$MySQLiconn->query("INSERT INTO $reporte(nombre, accion, modulo, departamento, registro) VALUES('$usuarioF','Agrego al contacto:  $nombre [".$get['nombresuc']."]','Contacto Sucursal','Logistica',NOW())");
}
