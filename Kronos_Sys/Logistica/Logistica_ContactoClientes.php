...
<div class="panel-heading"><b class="titulo">Contactos cliente</b><?php 
...
<select name="example" data-live-search="true"  class="selectpicker show-menu-arrow form-control" id="example" onChange="showCombo(this.value)">
    <?php
