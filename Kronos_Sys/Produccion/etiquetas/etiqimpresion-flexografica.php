...
$consul=$MySQLiconn->query("SELECT  lotes.idLote,lotes.anchuraBloque,lotes.noop,lotes.tarima,lotes.referenciaLote,lotes.numeroLote,impresiones.id as newid,`pro".$proceso."`.longitud as newLong,`pro".$proceso."`.peso as newPeso,`pro".$proceso."`.fecha as fecha,`pro".$proceso."`.unidades as newUnidades,impresiones.id,(select descripcion from producto where ID=impresiones.descripcionDisenio) as descripcionDisenio,impresiones.descripcionImpresion,impresiones.anchoPelicula,impresiones.anchoEtiqueta,impresiones.espaciofusion from impresiones  inner join `tbpro".$proceso."` `pro".$proceso."` on  impresiones.id=`pro".$proceso."`.producto inner join tblotes lotes on `pro".$proceso."`.noop=lotes.noop where `pro".$proceso."`.producto='".$producto."' and lotes.tipo='$tipo' and `pro".$proceso."`.total=1 and `pro".$proceso."`.tipo='$tipo'");
if($tipo=="1")
{
