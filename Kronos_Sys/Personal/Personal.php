...
if(isset($_GET['msj']))
{
 echo "<div class='alert alert-success alert-dismissible fade in'>
		...
		<strong>Operación exitosa</strong> , Datos médicos actualizados.
		</div>";
}
?>
	...
	<div class="panel-heading"><b class="titulo">Personal </b>
		<a href="funciones/importar.php" title="Cargar o actualizar datos médicos"><img src="../pictures/excel.png"></a>
	<?php 
...
<script type="text/javascript">
	$(document).ready(function()
         {
           $(function() {
             $(document).on('click', 'a.seguro', function(event) {
             	console.log('si entro we');
              let id = this.id;
              
              $.ajax({
                type: "POST",
                url: "funciones/crudEmpleado.php",
                data: "seguro="+id+"&conn="<?php $MySQLiconn;?>,
                dataType: "html",
                error: function(){
                  alert("error petición ajax");
                },
                success: function(data){                                                      
                  $("#showseguro").html(data);
                  $('#showseguro').show();
                  n();
                }
              });
           ...
           $(document).on('click','button#btnclose',function(event)
           {
           	$('#showseguro').hide();
           });
         });
