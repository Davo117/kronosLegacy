...
print("<th>Datos</th>");
	while ($rows = $resultado->fetch_array()) {
		...
		<a  href="funciones/ficha_salud.php?empleado=<?php echo $rows['numemple'];?>" target="_blank" id="<?php echo $rows["ID"];?>" class="seguro"><img src="../pictures/nurse.png" width="35" height="35" title="Ver historial médico"></a></td>
