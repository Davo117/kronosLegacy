...
<!-- EDITAR CONSULTA PARA QUE AL SELECCIONAR PRODUCTO SALGAN LAS ORDENES DE COMPRA DE ESE PRODUCTO   -->

<?php
/*
$ri=("SELECT * FROM confirmarprod where idConfi=".$row['id']."")

while($ro=$ri->fetch_array())
?>
...
<div class="col-xs-3">
<label for="planta">Orden de Compra.:</label>
