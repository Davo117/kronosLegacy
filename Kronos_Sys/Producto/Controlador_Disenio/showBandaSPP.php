...
if(isset($q))
{
	$resultado = $MySQLiconn->query("SELECT bs.*,s.descripcionSustrato as sustrato FROM bandaspp bs inner join sustrato s on s.idsustrato=bs.sustrato where  bs.baja=1 && bs.identificadorBS='$q'");
