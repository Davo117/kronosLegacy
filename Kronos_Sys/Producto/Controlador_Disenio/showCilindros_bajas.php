...
$resultado = $MySQLiconn->query("SELECT*from juegoscilindros inner join impresiones on juegoscilindros.descripcionImpresion=impresiones.id where juegoscilindros.baja=0 && juegoscilindros.descripcionImpresion='$q'");
