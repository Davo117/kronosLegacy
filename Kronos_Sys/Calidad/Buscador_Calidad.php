...
<form method="POST" name="formulary" id="formulary" role="form">
	...
	<div class="panel-heading"><b class="titulo">Buscador</b>
					</div>
						<div class="panel-body">

<div class="col-xs-3"><label for="lista">Tipo de Código*:</label>
<select name="lista" class="form-control" id="lista" required onchange="document.formulary.submit(); cambio(this.value);">
	...
	<option value="5" <?php if(isset($_POST['lista']) and $_POST['lista']=="5") echo "selected";?>>Lote</option>
</select>
</div>

<?php include("Controlador_Calidad/lista.php") ?>
...
if(isset($_POST['lista'])){
	if($_POST['lista']=="5" and !empty($_POST['codigo'])){
 ?>
	<a class="btn btn-warning" href="reporteLotes.php?codigo=<?php echo $_POST['codigo']?>"><img src="../pictures/excel.png">Generar reporte</a><?php
	}
}
