<?php
//Voy a modificar este módulo, a raíz de que cada vez que hay un ingeniero de producción nuevo, no hay manera desde el sistema de darle permiso de programar pproducto para fabricación
ob_start();
session_start();
