...
<select name="example" id="example" required data-live-search="true"  class="selectpicker show-menu-arrow form-control">
...
<?php echo $row['numemple']." | " .$row['Nombre'].' '.$row['apellido'];?>
</option>
<?php } ?>
</select>
</div>
