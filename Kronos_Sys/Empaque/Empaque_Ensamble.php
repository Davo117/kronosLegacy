...
for($i=0;$i<count($_SESSION['array']);$i++)
  {
    ?>
      <p class="paquetes"><?php echo $_SESSION['array'][$i];?><a  title="Quitar código" href="?comboEmpaque=<?php echo $_GET['comboEmpaque']?>&codigo=&out=<?php echo $_SESSION['array'][$i];?>" style="float:left;margin-right:4px"> <img class="img-responsive" width="15" height="15" src="../pictures/deletProducto.png"></a></p>
      <?php
      $comparador=$i;
  }	
