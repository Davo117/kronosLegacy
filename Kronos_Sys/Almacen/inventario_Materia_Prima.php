...
if(isset($_POST['cmbFchInicio']))
{
$fchProgramacion = $_POST['cmbFchInicio'];
}
else
{
...
<form method="POST" name="formulary" action="alm_doc/historicoExcel.php" id="formulary" role="form">
<div class="panel panel-default">
	<div class="panel-heading"><b class="titulo">Inventario de materia prima</b></div>
		<div class="panel-body">
			<div class="col-xs-2">
				<label for="">Inicio</label>
				<input class="form-control" type="date" id="cmbFchInicio" name="cmbFchInicio" value="<?php echo $fchProgramacion;?>">
			</div>	
			<div class="col-xs-2">
				<label>Hasta</label>
				<input class="form-control" type="date" id="cmbFchFinal" name="cmbFchFinal" value="<?php echo $fchFinal;?>">
			</div>
			<div class="col-xs-2">
				<label for="">Movimiento</label>
				<select class="selectpicker show-menu-arrow form-control" name="cmbMov" id="cmbMov" title="Selecciona tipo de movimiento">
			...
			<div class="col-xs-2">
				...
				<select required="true"  name="cdgproveedor" id="cdgproveedor"  class="selectpicker show-menu-arrow form-control" data-style="form-control" data-live-search="true" title="Selecciona el proveedor">
			...
			<div class="col-xs-2">
				...
				<select required="true"  name="cdgproducto" id="cdgproducto" class="selectpicker show-menu-arrow form-control" data-style="form-control" data-live-search="true" title="Selecciona un producto">
    			<?php $obel=$mysqli->query("SELECT  producto as id, id as codigo from obelisco.productosCK");?>
					<option value="0">Todos</option>
					<?php
			...
			<div class="col-xs-2">
				...
				<select class="selectpicker show-menu-arrow form-control" name="cmbFamilia" id="cmbFamilia" title="Selecciona la familia">
					<option value="0">Todos</option>
					<option value="1">Tintas</option>
					<option value="2">Acabados</option>
					<option value="3">Aditivos</option>
					<option value="4">Solventes</option>
					<option value="5">Adhesivos</option>
					<option value="6">Sustratos</option>
					<option value="7">Indirectos</option>
				</select>
			</div>
		</div>
<!-- botones guardar -->
	<input type="submit" placeholder="Generar reporte" value="Generar excel" style="float:right;" class="btn btn-large btn-success" title="Generar reporte en Excel">
